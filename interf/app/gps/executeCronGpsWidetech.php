<?php
  /***********************************************************************
  * @file server.php                                                     *
  * @brief Cron inserta Novedades de GPS Widetech                        *
  * @version 0.1                                                         *
  ...
  ************************************************************************/
  ...
  $fExcept -> SetParams( "Sat", "NovedaGPSWidetech" );
		...
		echo "</pre>";
          ...
          try
          {
            ...
            if( $xmlObject -> Response -> Status -> code == '100' )
            {
              ...
              $novedaGPS['det_ubicac'] = iconv( 'UTF-8', 'ISO-8859-1', (string) $xmlObject -> Response -> Plate -> hst -> Location );
