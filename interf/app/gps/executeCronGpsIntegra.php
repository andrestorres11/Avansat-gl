<?php
  /***********************************************************************
  * @file server.php                                                     *
  * @brief Cron inserta Novedades de GPS para Integra GPS o Prosegur     *
  * @version 0.1                                                         *
  ...
  ************************************************************************/
  ...
  $fExcept -> SetParams( "Sat", "NovedaGPSIntegra" );
  ...
  try
  {
    ...
    echo "<hr><pre>Nro Vehiculos:";
    print_r(  $fRecorVehiculos );
    echo "</pre>";
	  die();
      ...
      foreach( $fRecorVehiculos as $fVehiculo )
      {
        ...
        if( isset( $novedaGPS['all_infgps'] ) && $novedaGPS['all_infgps'] !== NULL )
        {
          ...
          if( "1000" != $mCodResp[1] )
          {
            ...
            mail( NotMai.", nelson.liberato@intrared.net " , "Web service GPS setNovedaGPS Integra CRON", $mMessage,'From: soporte.ingenieros@intrared.net' );
