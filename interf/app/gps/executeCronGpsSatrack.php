...
die();
  /***********************************************************************
  * @file server.php                                                     *
  * @brief Cron inserta Novedades de GPS Satrack                         *
  * @version 0.1                                                         *
  ...
  ************************************************************************/
  ...
  $fExcept -> SetParams( "Sat", "NovedaGPSSatrack" );
  ...
  try
  {
    ...
    $fQuerySelVehiculos = "SELECT a.cod_operad, a.cod_transp, a.nom_aplica, a.num_despac, " .
                           ...
                           "WHERE a.cod_operad = b.cod_operad ".
                             ...
                             "AND a.cod_operad = 900040838 ". 
                             #"AND a.num_despac = 1335204 ". 
    ...
    if( 0 != $db5 -> RetNumRows() )
    {
      foreach( $fRecorVehiculos as $fVehiculo )
      {
		...
		echo "</pre>";
		  ...
		  echo "<hr><pre>Respuesta Webservice<br>";
		  print_r( $result );
		  echo "</pre>";
