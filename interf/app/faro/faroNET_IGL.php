<?php
  ...
  ************************************************************************/
  ...
  //include_once( "/var/www/html/ap/interf/app/faro/ConfigDesarrollo.kons.php" );     //Constantes propias.
  ...
  include_once( "/var/www/html/ap/interf/app/faro/protoc_desarrollo.class.inc" );     //Constantes propias.
  ...
  * @param $fNumConfig: string Configuracion del vehiculo.               *
  * @param $fCodCarroc: string Codigo de la carroceria del vehiculo.     *
  * @param $fNumChasis: int    Numero del chasis del vehiculo.           *
  * @param $fNumMotorx: string Serial del motor vehiculo.                *
  * @param $fNumSoatxx: string Seguro obligatorio.                       *
  * @param $fDatVigsoa: date   Fecha vigencia Soat.                      *
  * @param $fNomCiasoa: string Nombre compania de seguro Soat.           *
  * @param $fNumTarpro: string Numero tarjeta de proipedad.              *
  * @param $fNumTrayle: stringMatricula remolque del vehiculo.          *
  ...
  ************************************************************************/
 function setSeguim( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL, 
                     $fCodManifi = NULL, $fDatFechax = NULL, $fCodCiuori = NULL, $fCodCiudes = NULL,
                     $fCodPlacax = NULL, $fNumModelo = NULL, $fCodMarcax = NULL, $fCodLineax = NULL, 
                     $fCodColorx = NULL, $fCodConduc = NULL, $fNomConduc = NULL, $fCiuConduc = NULL,
                     $fTelConduc = NULL, $fMovConduc = NULL, $fObsComent = NULL, $fCodRutaxx = NULL,
                     $fNomRutaxx = NULL, $fIndNaturb = 1,    $fNumConfig = "3S3",$fCodCarroc = 0,
                     $fNumChasis = 1111, $fNumMotorx = 1111, $fNumSoatxx = 1111, $fDatVigsoa = NULL,
                     $fNomCiasoa = "NA", $fNumTarpro = 1111, $fNumTrayle = NULL, $fCatLicenc = 1,
                     $fDirConduc = "NA", $fCodPoseed = NULL, $fNomPoseed = NULL, $fCiuPoseed = NULL,
                     $fDirPoseed = "NA", $mCodAgedes = NULL, $mCodContrs = NULL, $mCodAgenci = NULL,
                     $fCodoperad = NULL, $mCodGpsxxx = NULL, $mCodRemesa = NULL, $fBinHuella = NULL,
                     $fNumViajex = NULL, $fDatgps2xx = NULL, $fNumIntent = 0)
  {
    ...
    if( $flagCode === 0  )//AND count($mNumMessageGps) ===  1
    {
      try
      { 
        $validConection = getValidConection($fNomAplica);
        
        if($validConection['cod_respon']!=1000){
          throw new Exception( $validConection['msg_respon'], "1999" );
        }
      ...
      catch( Exception $e )
      {
        ...
        if( "3001" == $e -> getCode() )
        {
          ...
          if( $fNumIntent < 3 )
          {
            ...
            $fReturn = setSeguim( $fNomUsuari, $fPwdClavex, $fNomAplica, $fCodTranps, $fCodManifi,
...
//         return $fMessageFinally;
  ...
  * @param $fNomAplica    : string Nombre de la aplicacion a conectar    *
  ...
  ************************************************************************/
  function setSeguimPC( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                        $fCodManifi = NULL, $fDatFechax = NULL, $fCodPlacax = NULL, $fCodRutaxx = NULL,
                        $fObsComent = NULL, $fCodCiuori = NULL, $fCodCiudes = NULL, $fConTelmov = NULL,
                        $fNomConduc = NULL )
  {
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setSeguimFTP( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                         $fCodManifi = NULL, $fDatFechax = NULL, $fCodPlacax = NULL, $fCodRutaxx = NULL,
                         $fObsComent = NULL, $fCodCiuori = NULL, $fCodCiudes = NULL, $fConTelmov = NULL,
                         $fNomConduc = NULL, $fCodCondu2 = NULL, $fCodClien2 = NULL, $fNomClient = NULL,
                         $fEmaClient = NULL )
  {
    $fCodCiuori = trim( $fCodCiuori ) == '' ? NULL : $fCodCiuori; 
    $fCodCiudes = trim( $fCodCiudes ) == '' ? NULL : $fCodCiudes;
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setLlegada( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                       $fCodManifi = NULL, $fFecLlegad = NULL, $fObsLlegad = NULL, $fNumPlacax = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_tranps" =>  $fCodTranps, "cod_manifi" => $fCodManifi, 
    ...
    if( "1000" === $fMessages["code"] )
    {
      try
      {
        ...
        if($validConection['cod_respon']!=1000){
          throw new Exception( $validConection['msg_respon'], "1002" );
        }
        $fConsult = new Consult( array( "server"=> Hostxx, "user"  => USUARIO, "passwd" => CLAVE, "db" => BD_STANDA ), $fExcept );
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setAnulad( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                      $fCodManifi = NULL, $fNumPlacax = NULL, $fFecAnulad = NULL, $fObsAnulad = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_tranps" =>  $fCodTranps, "cod_manifi" => $fCodManifi, 
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setRevSalida( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                         $fCodManifi = NULL, $fNumPlacax = NULL, $fFecAnulad = NULL, $fObsAnulad = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_tranps" =>  $fCodTranps, "cod_manifi" => $fCodManifi, 
                      "num_placax" => $fNumPlacax, "fec_anulad" => $fFecAnulad, "obs_anulad" => $fObsAnulad  );
  ...
  * @return string mensaje de respuesta.                                   *
  **************************************************************************/
  function setRevLlegada( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                          $fCodManifi = NULL, $fNumPlacax = NULL, $fFecAnulad = NULL, $fObsAnulad = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_tranps" =>  $fCodTranps, "cod_manifi" => $fCodManifi, 
                      "num_placax" => $fNumPlacax, "fec_anulad" => $fFecAnulad, "obs_anulad" => $fObsAnulad  );
  ...
  * @return string respuesta del webservice.                             *
  ************************************************************************/  
  function setDespacPdf ($fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL,
                         $fCodManifi = NULL, $fCodPlacax = NULL)
  {
  ...
  * @return string respuesta del webservice.                             *
  ************************************************************************/
  function routExists( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodCiuori = NULL, 
                       $fCodCiudes = NULL, $fCodRutaxx, $fNomRutaxx = NULL )
  {
  ...
  * @return string respuesta del webservice.                             *
  ************************************************************************/
  function setRout( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodCiuori = NULL,
                    $fCodCiudes = NULL, $fNomRutaxx = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_ciuori" => $fCodCiuori, 
  ...
  * @return string respuesta del webservice.                             *
  ************************************************************************/
  function setPc( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTranps = NULL, 
                  $fCodRutaxx = NULL, $fCodContro = NULL, $fNomContro = NULL, $fValDuraci = NULL,
                  $fValDistan = NULL )
  {
  ...
  ************************************************************************/
  function getPCsContratados( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL,
                              $fCodTipdes = NULL, $fCodRutaxx = NULL, $fTieHolgur = 20 )
  {
  ...
  * @return string or Array mensaje de respuesta.                              *
  *****************************************************************************/
  function getRutas(  $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, 
                      $fCodCiuori = NULL, $fCodCiudes = NULL, $fNotRutasx = NULL,
                      $fCodTransp = NULL, $fCodTipdes = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_ciuori" => $fCodCiuori, 
  ...
  * @return string mensaje de respuesta.                                 *
  ***********************************************************************/
  function getTipser( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL, $fCodTipdes = NULL  )
  {
  ...
  * @return string or Array mensaje de respuesta.                        *
  ************************************************************************/
  function getNovedades( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL  )
  {
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setNovedadPC( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL,
                         $fNumManifi = NULL, $fNumPlacax = NULL, $fCodNoveda = NULL, $fCodContro = NULL,
                         $fTimDuraci = NULL, $fFecNoveda = NULL, $fDesNoveda = "", $fNomNoveda = NULL,
                         $fNomContro = NULL, $fNomSitiox = NULL, $fNumViajex = NULL  )
  {
      ...
      try
      {
        ...
        if($fNumViajex != NULL){         
          ...
          if($mValidaViaje[cod_respon] == '1000') {
              $mNoveCorona =  setNovedadNC( $fNomUsuari, $fPwdClavex, $fNomAplica, $mValidaViaje["msg_respon"]["cod_transp"], $mValidaViaje["msg_respon"]["cod_manifi"],
  ...
  * @return string mensaje de respuesta.                                  *
  ************************************************************************/
  function setCambioRuta( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL,
                          $fNumManifi = NULL, $fNumPlacax = NULL, $fCodRutasx = NULL, $fTimDuraci = NULL,
                          $fCodPcbase = NULL, $fCodContrs = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fNomUsuari );
  ...
  * @return string mensaje de respuesta.                                 *
  ************************************************************************/
  function setNovedadNC( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL,
                         $fNumManifi = NULL, $fNumPlacax = NULL, $fCodNoveda = NULL, $fCodContro = NULL,
                         $fTimDuraci = NULL, $fFecNoveda = NULL, $fDesNoveda = "", $fNomNoveda = NULL,
                         $fNomContro = NULL, $fNomSitiox = NULL, $fNumViajex = NULL, $fFotNoveda = NULL)
  {
...
//              throw new Exception( "Error en Insert.", "3001" );
  ...
  ***************************************************************************/
  function setRutaFaro( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL,
                        $fCodTranps = NULL, $fCodRutasx = NULL, $fNomRutasx = NULL,
                        $fCodPaiori = NULL, $fCodDepori = NULL, $fCodCiuori = NULL,
                        $fCodPaides = NULL, $fCodDepdes = NULL, $fCodCiudes = NULL,
                        $fObjPcontr = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fNomUsuari );
  ...
  * @return string mensaje de respuesta.                                     *
  ****************************************************************************/
  function setTelConduc( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, 
                         $fCodTranps = NULL, $fCodConduc = NULL, $fTelConduc = NULL )
  {
    $fInputs = array( "nom_usuari" => $fNomUsuari, "pwd_clavex" => $fPwdClavex, "cod_tranps" =>  $fCodTranps, 
        ...
        if( getAutentica( $fNomUsuari, $fPwdClavex, $fExcept ) )
        {
          ...
          if( 0 != $fConsult -> RetNumRows() )
          {
            ...
            for( $i = 0, $total = count( $fManifis ); $i < $total; $i++ )
            {
              ...
              $resultNoveda = setNovedadNC( $fNomUsuari, $fPwdClavex,  $fNomAplica, $fCodTranps, $fManifis[$i]['cod_manifi'],
  ...
  * @return string mensaje de respuesta o array de rutas y puestos.            *
  *****************************************************************************/
  function setHomoloData( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL,
                          $fCodTranps = NULL, $fCodRutfar = NULL, $fCodRutbas = NULL,
                          $fObjHomolo = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fNomUsuari );
  ...
  function getHomoloData( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, 
                            $fCodTranps = NULL, $fCodRutasx = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fNomUsuari );
  ...
  * @param $fNomAplica: string Nombre aplicacion.                        *
  ************************************************************************/
  function setSalida( $fNomUsuari = NULL, $fPwdClavex = NULL, $fNomAplica = NULL, $fCodTransp = NULL,
                      $fCodManifi = NULL, $fNumPlacax  = NULL, $fFecSalida = NULL, $fObsSalida = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fNomUsuari );
  ...
  function RegistrarCall( $fUsrCallxx = NULL, $fClvCallxx = NULL, $fNomAplica = NULL, $fTokCallxx = NULL,
                          $fNumDespac = NULL, $fNumPlacax = NULL, $fNumTelefo = NULL, $fTieDuraci = NULL,
                          $fIdxLlamad = NULL, $fNomEstado = NULL, $fRutAudiox = NULL )
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
  ...
  function RegistrarCallIn( $fUsrCallxx = NULL, $fClvCallxx = NULL, $fNomAplica = NULL, $fTokCallxx = NULL, 
                            $fNumTelefo = NULL, $fTieDuraci = NULL, $fIdxLlamad = NULL, $fNomEstado = NULL,
                            $fRutAudiox = NULL, $fCodExtenc = NULL, $fIdxServic = NULL)
  {
    $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
    $fExcept -> SetUser( $fUsrCallxx );
  ...
  function LogCallcenter($fDataCallcenter = NULL, $fConsult = NULL, $fActionLog = 'Add')
  {
    ...
    *  \param: mNomAplica  String   Nombre de la aplicacion gl
    *  \par am: mIndGroupx  Boolean  Indicador de agrupacion
    *  \return: Matriz
    */
    function getDestin( $mUser = NULL, $mPass = NULL, $fNomAplica = NULL, $mNumDespac = NULL )
    {
    ...
    *  \return: Matriz
    */  
    function setFecAditio( $mUser = NULL, $mPass = NULL, $fNomAplica = NULL, $mNumDespac = NULL, $mTipFecha = NULL, $mNumFecha = NULL, $mNumFactur = NULL)
    {
    ...
    */  
    function setValidaCredenciales( $mUser = NULL, $mPass = NULL, $mNomPalica = NULL)
    {
      ...
      try {
        ...
        $validConection = getValidConection($mNomPalica);
    ...
    function getValidConection($fNomAplica = NULL){
      try {
        $fExcept = new Error( array( "dirlog" => LogDir, "notlog" => TRUE, "logmai" => NotMai ) );
        $fExcept -> SetParams( "WS - GL", "getValidConection" );
        $fReturn = [];

        if($fNomAplica == NULL){
          throw new Exception( "Debe suministar el nombre de la aplicaci�n GL.", "1999" );
          break;
        }
        ...
        }else if(file_exists( RootDir.'generadores/'.$fNomAplica."/constantes.inc")){
          include_once(RootDir.'generadores/'.$fNomAplica."/constantes.inc");
        }else if(file_exists( RootDir.'latino/'.$fNomAplica."/constantes.inc")){
          include_once(RootDir.'latino/'.$fNomAplica."/constantes.inc");
        }else if(file_exists( RootDir.'integradorgps/'.$fNomAplica."/constantes.inc")){
          include_once(RootDir.'integradorgps/'.$fNomAplica."/constantes.inc");
        }else{
          throw new Exception( "Aplicacion sat trafico no encontrada (".$fNomAplica."). Por favor valide el directorio.", "1999" );
          break;
        }
        
        $fReturn['cod_respon'] = "1000";
        $fReturn['msg_respon'] = "Aplicaci�n Encontrada y Disponible.";      
  ...
  try
  {
    $server = new SoapServer( WsDirx."faroNET_IGL.wsdl", array('encoding'=>'ISO-8859-1') );
    ...
    $file = fopen('/var/www/html/ap/interf/app/faro/logs/faroNET_XMLDESARROLLO_'.date("Y_m_d").'.txt', 'a+');
    fwrite($file,  "----------------------------------------  FECHA LOG ".date("Y-m-d H:i:s")." ------------------------------------------\n");
