<?php
  ...
  define( "AplKon", "/var/www/html/ap/satt_faro/constantes.inc" ); //Constantes de la aplicacion cliente.
  ...
  define( "Hostxx", "aglbd.intrared.net:3306" );                                                   //Servidor de base de datos ambiente 5.
  
  define( "DirLogoTranspo", "/var/www/html/ap/satt_faro/logos/" );                                           //Dirección para el logo de la transportadora.
  define( "DirImagTrafico", "/var/www/html/ap/satt_faro/imagenes/" );                                           //Dirección para el logo de la transportadora.
  define( "DirStanTrafico", "/var/www/html/ap/satt_standa/imagenes/" );                                           //Dirección para el logo de la transportadora.
  define( "DirPhotoConduc", "/var/www/html/ap/satt_faro/fotcon/" );                                           //Dirección para la foto de conductor.
  define( "DirPhotoVehicu", "/var/www/html/ap/satt_faro/fotveh/" );                                           //Dirección para la foto del vehiculo.
  define( "DirSolici", "/var/www/html/ap/satt_faro/files/solici/" );                                           //Dirección para la cargar archivos de solicitudes
