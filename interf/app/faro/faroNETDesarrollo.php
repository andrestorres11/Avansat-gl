...
//              throw new Exception( "Error en Insert.", "3001" );
  ...
  ************************************************************************/
    ...
    function getValidConection($fNomAplica = NULL){
      try {
        ...
        if( file_exists( RootDir.$fNomAplica."/constantes.inc") )
        {
          ...
          throw new Exception( "Aplicacion sat trafico no encontrada. Por favor valide el directorio.", "1999" );
          break;
        }

        $fReturn['cod_respon'] = "1000";
        $fReturn['msg_respon'] = "Aplicación Encontrada y Disponible.";         
  ...
  try
  {
    $server = new SoapServer( WsDirx."faroNETDesarrollo.wsdl", array('encoding'=>'ISO-8859-1') );
