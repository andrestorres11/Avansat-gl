			...
			$mQuery = "	
						...
						LEFT JOIN ".BASE_DATOS.".tab_genera_noveda f ON a.cod_noveda  =  f.cod_noveda
							...
							WHERE
									...
									-- AND aa.num_despac IN (8924)
									AND a.fec_creaci BETWEEN '2023-08-01 00:00:00' AND '2023-08-02 09:10:00'
								AND a.usr_creaci != 'InterfGpsIntegr'
								AND ee.nom_operad != 'satt_intgps'
