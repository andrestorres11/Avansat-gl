					...
					$mHtml->OpenDiv("id:vehiculos_novedades");
						...
						if(sizeof($estado_vehiculo[0]) != 0)
						{
							...
							$mHtml->CloseRow();
								...
								for ($a=0; $a <sizeof($estado_vehiculo[0]); $a++) {
									$mHtml->Row();
										...
										$mHtml->Hidden(array( "name" => "vehiculo_nom_tercer".$a, "id" => "vehiculo_nom_tercer".$a, "value"=>$estado_carga[0][$a]['nom_tercer']) );
										$mHtml->Hidden(array( "name" => "vehiculo_num_placax".$a, "id" => "vehiculo_num_placax".$a, "value"=>$estado_carga[0][$a]['num_placax']));
										$mHtml->Hidden(array( "name" => "vehiculo_num_despac".$a, "id" => "vehiculo_num_despac".$a, "value"=>$estado_carga[0][$a]['num_despac']));
										$mHtml->Hidden(array( "name" => "vehiculo_nom_conduc".$a, "id" => "vehiculo_nom_conduc".$a, "value"=>$estado_carga[0][$a]['nom_conduc']));				
										$mHtml->Hidden(array( "name" => "vehiculo_cod_noveda".$a, "id" => "vehiculo_cod_noveda".$a, "value"=>$estado_carga[0][$a]['cod_noveda']));		
										$mHtml->Hidden(array( "name" => "vehiculo_obs_noveda".$a, "id" => "vehiculo_obs_noveda".$a, "value"=>$estado_carga[0][$a]['obs_noveda']));
									$mHtml->CloseRow();
								}
						}
						else
