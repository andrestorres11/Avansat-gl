...
class ajax_asiste_carret
{
  ...
  private function enviarCorreo($num_solici,$nombre_cliente,$correod,$solicitud,$nom_solici) {
    $logo = 'https://dev.intrared.net:8083/ap/ctorres/sat-gl-2015/satt_standa/imagenes/logo-clfaro-640w.png';
    ...
    $headers .= "From: servicioalcliente@fortecem.net";
                              ...
                              <tr style="border-collapse:collapse;">
                                <td align="left" style="padding:0;Margin:0;padding-left:20px;padding-right:20px;">
                                  ...
                                  <br><strong class="colortext">Solicitud de: </strong> '. $nom_asiste .' <br> <br><strong class="colortext">'.$this->darNombreCliente($_SESSION['datos_usuario']['cod_usuari']).'</strong>                                    <br> <br><strong class="colortext">Fecha y hora de la solicitud: </strong> '. $fec_actual .' <br> <br class="colortext">Señor(a):
                                    ...
                                    <strong
                                      class="colortext">En proceso de validación.</strong> <br> <br class="colortext">Le estaremos informando el estado de su solicitud, cabe
                                      aclarar que nuestro tiempo de respuesta es de aproximadamente 45 minutos o antes. <br> <br> </p>
                                </td>
                              </tr>
                            </table>
                          </td>
