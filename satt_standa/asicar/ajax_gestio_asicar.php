<?php
    ...
    FUNCION:  Retorna todos los datos necesarios para construir la informaci贸n
    FECHA DE MODIFICACION: 13/04/2020
    CREADO POR: Ing. Cristian Andr茅s Torres
    MODIFICADO 
    ****************************************************************************/
    ...
    class AjaxGestioAsiscar
    {
        ...
        /*! \fn: informes
           *  \brief: Genera la informaci锟絥 para las tablas de los informes
        ...
        */
        ...
        /*! \fn: informeGeneral
           *  \brief: Genera la informaci贸n para las tabla del informe general
           *  \author: Ing. Cristian Torres
           *  \date: 04-06-2020
           *  \date modified: dd/mm/aaaa
           *  \param: 
        ...
        */
        ...
        /*! \fn: informeEspecifico
           *  \brief: Genera la informaci锟絥 para las tabla del informe especifico por dia segun los filtros
           *  \author: Ing. Cristian Torres
           *  \date: 13-04-2020
           *  \date modified: dd/mm/aaaa
           *  \param: 
        ...
        */
        ...
        /*! \fn: cleanArray
           *  \brief: Limpia los datos de cualquier caracter especial para corregir codificaci贸n
           *  \author: Ing. Luis Manrique
           *  \date: 03-04-2020
           *  \date modified: dd/mm/aaaa
           *  \param: $arrau => Arreglo que ser谩 analizado por la funci贸n
           *  \return: array
        */
        ...
        function registroGestioSolici(){
            try {
                ...
                echo json_encode($return);
                  ...
                  echo 'Excepci贸n registrar: ',  $e->getMessage(), "\n";
                }
        }
...
//////////////////////////////////FUNCIONES RELACIONADAS AL ENVIO DE CORREOS///////////////////////////////////////////////////////////////
        ...
        private function enviarCorreo($num_solici,$cod_estado,$observacion) {
            ...
            <head>
              ...
              <title>Nuevo correo electr贸nico 2</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                          <tr style="border-collapse:collapse;">
                                            <td align="left" style="text-align: center; padding:0;Margin:0;padding-top:40px;">
                                              <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:20px;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:60px;color:#333333;"><b>Solicitud N掳. '.$num_solici.' </b></p>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                          ...
                                          <tr style="border-collapse:collapse;">
                                            <td align="left" style="padding:0;Margin:0;padding-left:20px;padding-right:20px;">
                                              <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;color:#655e5e;">
                                                <br><strong class="colortext">Solicitud de: </strong> '. $nom_asiste .' <br> <br><strong class="colortext">'.$this->darNombreCliente($_SESSION['datos_usuario']['cod_usuari'],1).'</strong>                                    <br> <br><strong class="colortext">Fecha y hora de la solicitud: </strong> '. $fec_actual .' <br> <br class="colortext">Se帽or(a):
                                                '. $nom_solici .'. <br> <br class="colortext">Por medio del presente correo la l铆nea de servicio <strong>Asistencia Log铆stica</strong> del <strong>Grupo OET</strong>, le informa que su solicitud se encuentra en el. <br> <br class="colortext">Estado:
                                                <strong class="colortext">'.$estado.'</strong><br>
                                                <br><strong style="color:#000">Observaci贸n:</strong> '.$observacion.'
                                                '.$complemento.'
                                                <br>
                                          ...
                                          <tr style="border-collapse:collapse;">
                                            <td align="center" style="padding:0;Margin:0;padding-bottom:10px;">
                                              <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:10px;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:10px;color:#333333;">
                                                Copyright 漏 '.date('Y').'. Todos Los Derechos Reservados. Dise帽ado y desarrollado por Grupo OET S.A.S.</p>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
