...
class CentroOperacion
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/LoadModuleOperac.js' ></script>\n";
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "OPERACIONES", "formulario" );
		echo "<td>";
...
$centro = new CentroOperacion( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
