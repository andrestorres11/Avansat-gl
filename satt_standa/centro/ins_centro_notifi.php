<?php
#--------------------------------------------------------------------
#@class: CentroNotificacion                                     -----
#@company: Intrared.net                                         -----
#author: Felipe Malaver (felipe.malaver@intrared.net )          -----       
#@date:  2013-12-11                                             -----                                
#@brief: Clase que pinta el formulario del módulo               -----                                          
...
class CentroNotificacion
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/LoadModuleNotify.js' ></script>\n";
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "CENTROS DE OPERACIÓN", "formulario" );
		echo "<td>";
...
$centro = new CentroNotificacion( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
