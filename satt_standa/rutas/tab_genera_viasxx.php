    ...
    */
    ...
    private function styles(){
        echo '
            ...
            <link href="../' . DIR_APLICA_CENTRAL . '/estilos/tab_genera_viasxx.css" rel="stylesheet">
        ';
    }
...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <!-- Custom Theme Scripts -->
            <script src="../' . DIR_APLICA_CENTRAL . '/js/tab_genera_viasxx.js?rand='.rand(150, 20000).'"></script>
        ';
    }
            ...
            <div class="modal-body">
                    ...
                    <div class="row margin-top-row">
                        <div class="col-md-4">
                            ...
                            <input class="form-control form-control-sm" type="text" placeholder="Nombre de la via" id="nom_viasxxID" name="nom_viasxx" required>
                        </div>
                    </div>
            </div>
...
$proceso = new tab_genera_viasxx($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
