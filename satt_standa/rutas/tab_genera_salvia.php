    ...
    */
    ...
    private function styles(){
        echo '
            ...
            <link href="../' . DIR_APLICA_CENTRAL . '/estilos/tab_genera_salvia.css" rel="stylesheet">
        ';
    }
...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <!-- Custom Theme Scripts -->
            <script src="../' . DIR_APLICA_CENTRAL . '/js/tab_genera_salvia.js?rand='.rand(150, 20000).'"></script>
        ';
    }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row margin-top-row">
                        <div class="col-md-4">
                            <label class="col-12 control-label"><span class="redObl">*</span> Nombre de la salida vial</label>
                            <input class="form-control form-control-sm" type="text" placeholder="Nombre de la salida vial" id="nom_salviaID" name="nom_salvia" required>
                        </div>
                    </div>
            </div>
...
$proceso = new tab_genera_salvia($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
