       	...
       	#<DIV fitro>
        	...
        	$mHtml->CloseForm();
				...
				$mHtml->OpenDiv("id:tabla1; class:accordion");
					$mHtml->SetBody("<h4 class='fuente' id='alerta'><center><B>AGREGAR OPERACI&Oacute;N</B></center></h4>");
			...
			$mHtml->OpenDiv("id:tabla; class:accordion");
				$mHtml->SetBody("<h4 class='fuente'><center><B>LISTADO DE OPERACIONES</B></center></h4>");
