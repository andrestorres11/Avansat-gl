       	...
       	#<DIV fitro>
        	...
        	$mHtml->CloseForm();
				...
				$mHtml->OpenDiv("id:tabla1; class:accordion");
					$mHtml->SetBody("<h4 class='fuente' id='alerta'><center><B>AGREGAR EXTENSI&Oacute;N</B></center></h4>");
			...
			$mHtml->OpenDiv("id:tabla; class:accordion");
				$mHtml->SetBody("<h4 class='fuente'><center><B>LISTADO DE EXTENCIONES</B></center></h4>");
				$mHtml->OpenDiv("id:sec2");
					$mHtml->OpenDiv("id:form3; class:contentAccordionForm");
						 $mSql = "SELECT a.cod_extenc,b.nom_operac,c.nom_grupox,a.num_extenc,a.usr_extenc,
