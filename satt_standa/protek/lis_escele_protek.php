  ...
  class AnulaProtek
  {
    ...
    function Listar()
    {
      ...
      if( sizeof( $matriz ) > 0 )
      {
        ...
        $formulario -> linea("No. Solicitud",0,"t");        
        $formulario -> linea("Ruta Protekto",0,"t");        
        $formulario -> linea("Vehículo",0,"t");        
        $formulario -> linea("No. Remolque",0,"t");        
        $formulario -> linea("No. Contenedor",0,"t");        
        $formulario -> linea("Conductor",0,"t");
        $formulario -> linea("Cliente",0,"t");
        $formulario -> linea("Origen",0,"t");
        $formulario -> linea("Destino",0,"t");
        $formulario -> linea("Fecha Programada",1,"t");        
        ...
        for($i = 0; $i < sizeof($matriz); $i++)
        {
          ...
          $formulario -> linea($matriz[$i][14],0,$estilo);
          $formulario -> linea($RUTA,0,$estilo);
          ...
          $formulario -> linea($matriz[$i][13],1,$estilo);
        }
      }
      else
      {
