...
// *****************************************************
 function Buscar()
 {
   ...
   $formulario = new Formulario ("index.php","post","Bucar y Eliminar Clases","form_act");
...
// *****************************************************
 function Datos()
 {
  ...
  $matriz = $consulta -> ret_matriz();
     $inicio[0][0]='-';
        $inicio[0][1]='-';
   $formulario = new Formulario ("index.php","post","Eliminacion de Clases","form_item");
   $formulario -> nueva_tabla();
...
}//FIN CLASE Eli_clases_config
   $proceso = new Eli_clases_config($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
?>