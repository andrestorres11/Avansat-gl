                  ...
                  $mHtml->SetBody("<h1 style='padding:6px' ><b>LISTADO DE AGENCIAS</b></h1>");
                    $mHtml->OpenDiv("id:sec2");
                      $mHtml->OpenDiv("id:form3; class:contentAccordionForm");
                        ...
                        $list->SetHeader(utf8_decode("CÛdigo de la agencia"), "field:a.cod_agenci; width:1%;  ");
                        ...
                        $list->SetHeader(utf8_decode("DirecciÛn"), "field:a.dir_agenci; width:1%");
                        $list->SetHeader(utf8_decode("TelÈfono"), "field:a.tel_agenci; width:1%");
