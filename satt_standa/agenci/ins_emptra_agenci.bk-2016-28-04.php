            ...
            $mHtml->Row("td");
              $mHtml->OpenDiv("id:tablaID; class:contentAccordion");
                $mHtml->OpenDiv("id:tabla; class:accordion");
                  $mHtml->SetBody("<h3 class='fuente'><center>LISTADO DE AGENCIAS</center></h3>");
              ...
              $mHtml->OpenDiv("id:form1; class:contentAccordionForm");
                $mHtml->Table("tr");
                  $mHtml->Label("Transportadora:", "width:25%; *:1;");
                    ...
                    $mHtml->Input(array("type" => "number", "name" => "agenci[dir_emailx]", "validate" => "email",  "minlength" => "7", "maxlength" => "225", "id" => "dir_emailxID", "width" => "25%", "value" => $datos->dir_emailx, "end" => true));
