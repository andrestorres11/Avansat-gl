...
class ins_homolo_homolo{
  ...
  function __construct($conexion, $us, $ca){
    @include_once('../' . DIR_APLICA_CENTRAL . '/homnov/ajax_homolo_homolo.php');
    
    $this->cFunction = new ajax_homolo_homolo($conexion, $us, $ca);
  ...
  function showFilters(){
    ...
    <script type="text/javascript" language="JavaScript" src="../<?= DIR_APLICA_CENTRAL ?>/js/ins_homolo_homolo.js"></script>
    ...
    <div id="acordeonID" class="col-md-12 accordion ancho">
      <h1 style="padding: 6px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Homologar Novdades - Insertar</b></h1>
      <div id="contenido">
        <div  class="Style2DIV">
          ...
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <th class="CellHead text-center" colspan="6" ><label id="notify"><b>Creaci&oacute;n y modificaci&oacute;n en homologaci&oacute;n de novedades</b></label>&nbsp;&nbsp;</th>
            </tr>
            <tr class="Style2DIV">
              <td class="contenido" colspan="6" id="primero" style="text-align:center">
                <div class="col-md-12" id="div0">
                  <div class="col-md-1 izquierda">
                  <input type="hidden" name="cod_estcli" id="cod_estcli" value="">
                  </div>
                  <div class="col-md-1 derecha">Nombre Estado<font style="color:red">*</font>:</div>
                  <div class="col-md-3 izquierda">
                    <input type="text" id="nom_estcli" validate="dir" obl="1" maxlength="30" minlength="5" name="nom_estcli" class="ancho">
                  </div>
                  <div class="col-md-2 derecha">Estado:</div>
                  <div class="col-md-1 izquierda">
                     <input type="checkbox" id="ind_estcli" maxlength="30" minlength="5" name="ind_estcli" class="ancho">
                  </div>
                </div>
              </td>
            </tr>
...
$service = new ins_homolo_homolo($this->conexion,$this->usuario_aplicacion,$this->codigo);
?> 
