...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <!-- Custom Theme Scripts -->
            <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_genera_hoceva.js?rand='.rand(150, 20000).'"></script>
        ';
    }
            ...
            <div class="modal-body">
                    ...
                    <div class="row margin-top-row">
                        <div class="col-md-4">
                            ...
                            <input class="form-control form-control-sm" type="text" placeholder="Codigo RID (Ceva)" id="rid_hocevaID" name="rid_hoceva" required>
                        </div>
                          <div class="col-md-4">
                            <label class="col-12 control-label"><span class="redObl">*</span> Alias (Ceva)</label>
                            <input class="form-control form-control-sm" type="text" placeholder="Alias (Ceva)" id="des_hocevaID" name="des_hoceva" required>
                        </div>
                          <div class="col-md-4">
                            <label class="col-12 control-label"><span class="redObl">*</span> Codigo Avansat GL</label>
                            <input class="form-control form-control-sm" type="text" placeholder="Codigo Avansat GL" id="oet_hocevaID" name="oet_hoceva" required>
                        </div>
                    </div>
            </div>
...
$proceso = new ins_genera_hoceva($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
