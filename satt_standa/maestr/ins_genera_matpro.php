...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <!-- Custom Theme Scripts -->
            <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_genera_matpro.js?rand='.rand(150, 20000).'"></script>
        ';
    }
  ...
  */
  ...
  function modalRegistro(){
    ...
    $datos_option_etapa = $this->darEtapa();
            ...
            <div class="modal-body">
                    ...
                    <div class="row margin-top-row">
                        <div class="col-md-8">
                            ...
                            <input class="form-control form-control-sm" type="text" placeholder="Nombre del Evento" id="nom_eventID" name="nom_event" required>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row margin-top-row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="des_protocID" name="des_protoc" rows="10" placeholder="Escribe la gestion a realizar..." maxlength="1500" style="resize: none;" required></textarea>
                        </div>
                    </div>
            </div>
  ...
  function darEtapa(){
    ...
    foreach($respuesta as $dato){
      $html.='<option value="'.$dato['cod_etapax'].'">'.$dato['nom_etapax'].'</option>';
    }
...
$proceso = new ins_genera_matpro($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
