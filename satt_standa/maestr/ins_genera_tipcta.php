...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_genera_tipcta.js?rand='.rand(150, 20000).'"></script>
        ';
    }
...
$proceso = new genera_tipcta($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
