...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_genera_region.js?rand='.rand(150, 20000).'"></script>
        ';
    }
...
$proceso = new parametrizacion_region($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
