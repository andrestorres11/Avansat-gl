...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_genera_bancox.js?rand='.rand(150, 20000).'"></script>
        ';
    }
...
$proceso = new genera_banco($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
