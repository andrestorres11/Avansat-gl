                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse show m-3" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="card-body" style="width: 100%; overflow: auto;">
                            ...
                            <input type="hidden" id="tableUsu" value="0">
        ...
        function creaPestanas(){
            ...
            foreach($resultados as $key => $resultado){
                ...
                $html .= '<li class="nav-item m-2">
                            <a class="btn btn-success btn-sm '.$active.'" id="pills-'.$pestana.'-tab" data-toggle="pill" href="#pills-'.$pestana.'" role="tab" aria-controls="pills-'.$pestana.'" aria-selected="'.$aselect.'" onclick="changeTableUsu('.$pestana.')">'.$resultado['nom_etapax'].'</a>
                        </li>';
            }

            if(self::$cod_perfil == COD_PERFIL_ADMINIST){
                $html .= '<li class="nav-item m-2">
                            <a class="btn btn-success btn-sm " id="pills-novsta-tab" data-toggle="pill" href="#pills-novsta" role="tab" aria-controls="pills-novsta" aria-selected="false" onclick="changeTableUsu('.$pestana.')">Novedades Estandar</a>
                        </li>';
            }
            return $html;
        }
            ...
            foreach($resultados as $key=>$etapa){
                ...
                $novedades = $resultado_2->ret_matriz();
                    ...
                    foreach($novedades as $key_nov => $novedad){
                        ...
                        $gpsalar = $_POST['gpsalar_'.$cod_noveda] ? $_POST['gpsalar_'.$cod_noveda]:0;
                        if($gpsalar==0){
                            $gpsalar = $_POST['gpsalar_'.$cod_noveda."_T"] ? $_POST['gpsalar_'.$cod_noveda."_T"]:0;
                        }
