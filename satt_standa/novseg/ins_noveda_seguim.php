<?php
	...
	****************************************************************************/
		...
		*/
        ...
        private function scripts(){
            ...
            echo '
                ...
                <script src="../' . DIR_APLICA_CENTRAL . '/js/ins_noveda_seguim.js"></script>
            ';
        }
                    ...
                    <meta name="viewport" content= "width=device-width, initial-scale=1.0">
                            ...
                            <div class="container" style="min-width: 98%;">
                                <div class="row mt-2 mb-2">
                                    <div class="col-md-4">
                                        <button type="button" class="btn btn-success btn-sm" onclick="opeEdit(``, 0)">Crear Nueva Novedad</button>
                                    </div>
                                </div>
                                <div id="accordion">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <input type="text" id="nom_noveda" name="nom_noveda">
                                                    </div>
                                                    <div class="col-2 text-right">
                                                        <label>C&oacute;digo de novedad</label>
                                                    </div>
                                                    <div class="col-2">
                                                        <input type="text" id="cod_noveda" name="cod_noveda">
                                                    </div>
                                                    <div class="col-1 text-right">
                                                        <label>Etapa:</label>
                                                    </div>
                                                    <div class="col-2">
                                                        <select id="cod_etapax" name="cod_etapax" style="width:150px;">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-3">
                                                        <select id="cod_riesgo" name="cod_riesgo" style="width:150px;">
                                                            <option value="" selected>Todos</option>
                                                            '.$this->getRiesgo().'
                                                        </select>
                                                    </div>
            ...
            <div class="row">
              <div class="col-md-0 col-sm-12">
                <div class="form-group" id="cod_novedaSpace">
                  <label for="cod_novedaID" class="labelinput">CÛdigo:</label>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label class="mt-2" for="rut_iconoxID"><strong>Se aceptan formatos jpg y png. tamaÒos (16x16, 24x24, 32x32, 64x64, 128x128, 256x256, 512x512 px)</strong></label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <label for="nom_observaID">ObservaciÛn</label>
    ...
    new InsNovedadSeguimiento($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
?>