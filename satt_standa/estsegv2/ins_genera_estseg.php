                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2 text-right">
                                                      <label>Placa / Identificaci�n:</label>
                                                    </div>
                                                    <div class="col-2">
                  ...
                  <div class="col-md-6 col-sm-12 form-group" style="margin-bottom: 0 !important;">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 mb-2">
                        <label for="nom_soliciID" class="labelinput">
                        <div class="obl">*</div>
                          Cedula de ciudadan�a del propietario
                        </label>
                  ...
                  <div class="col-md-6 col-sm-12 form-group" style="margin-bottom: 0 !important;">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 mb-2">
                        <label for="nom_soliciID" class="labelinput">
                          <div class="obl">*</div>
                            C�dula de ciudadan�a del conductor
                        </label>
                  ...
                  <div class="col-md-6 col-sm-12 form-group" style="margin-bottom: 0 !important;">
                    <div class="row">
                      <div class="col-md-12 col-sm-12 mb-2">
                        <label for="nom_soliciID" class="labelinput">
                          <div class="obl">*</div>
                          Registro Fotogr�fico del vehículo.
                        </label>
