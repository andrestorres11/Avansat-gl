    ...
    ****************************************************************************/
    ...
    class AjaxGeneraEstSeg
    {
        ...
        function getConfigTipSer($cod_transp){
          ...
          function getListDocuments(){
            ...
            foreach($documentos as $key=>$value){
              ...
              if($value['obs_archiv']=='' || $value['obs_archiv'] == NULL){
                $value['obs_archiv'] = utf8_encode('**SIN OBSERVACI�N**');
              }
              $html.='<tr>
          ...
          */
          ...
          function redimensionarImagen($origin, $destino, $newWidth, $newHeight, $jpgQuality = 85) {
            ...
            // Guardar la nueva imagen redimensionada con compresi�n JPEG
          ...
          */
          private function creaDespacho($data){
            try{
                ...
                $obs_despac = 'Despacho creado automaticamente a traves del m�dulo de estudio de seguridad';
        ...
        */
        ...
        private function armaPDF(){
          try {
            ...
            self::generateLog("C�digo Solicitud: ".$_REQUEST['cod_solici']." || ".$e->getMessage(), $e->getCode());
            return array(
              'status' => false,
              'error' => array(
                  'code' => $e->getCode(),
        ...
        */
        ...
        /*! \fn: getPDFGenerado
        *  \brief: retorna la ubicaci�n del PDF generado del estudio de seguridad
          ...
          try {
            ...
            if($docume['fil_result'] != NULL){
              echo json_encode(array(
                ...
                'message' => utf8_encode('PDF Abierto en una nueva pesta�a')
              ));
            }else{
              throw new Exception("No hay archivo PDF Generado", "2001");
            }
          } catch (Exception $e) {
            self::generateLog("C�digo Solicitud: ".$_REQUEST['cod_solici']." || ".$e->getMessage(), $e->getCode());            echo json_encode(array(
              'status' => false,
              'error' => array(
                  'code' => $e->getCode(),
                  'message' => $e->getMessage()
