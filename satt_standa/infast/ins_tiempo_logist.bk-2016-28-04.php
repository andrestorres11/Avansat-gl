...
class TiemposLogisticos
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/ins_tiempo_logist.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    $this -> Style();
    $formulario = new Formulario ( "index.php", "post", "CONFIGURAR TIEMPOS LOGISTICOS", "formulario" );
...
$_PROC = new TiemposLogisticos( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo  );
