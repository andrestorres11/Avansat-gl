...
class HomologarConfiguracion
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/hom_config_vehicu.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/informes.css' type='text/css'>\n";
    $formulario = new Formulario ( "index.php", "post", "HOMOLOGAR CONFIGURACION", "formulario" );
...
$_PROC = new HomologarConfiguracion( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo  );
