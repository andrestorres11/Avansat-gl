...
class ModuloComunicaciones
{
  ...
  private function principal()
  {
    ...
    $formulario = new Formulario ( "index.php", "post", "PARAMETRIZAR INDICADOR SOLUCION A NOVEDAD", "formulario" );
		echo "<td>";
    ...
    { 
      ...
      $readonly = 'readonly="readonly" value="'.$TRANSP[0][0].' - '.$TRANSP[0][1].'"';
        ...
        <input type='hidden' name='ind_config' id='ind_configID' value='1'>
        <input type='hidden' name='cod_ciudad' id='cod_ciudadID' value='1'>
				<input class='crmButton small save' style='cursor:pointer;' type='button' value='Generar' onclick='ValidateTransp(1);'/></td>";
		echo "</tr>";
		echo "</table></td>";
		$formulario -> cerrar();
