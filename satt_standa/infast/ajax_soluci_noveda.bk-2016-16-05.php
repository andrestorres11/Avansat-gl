    ...
    private function getInform() {
        ...
        $mHtml .= "<div class='col-md-12 StyleDIV' style='overflow:scroll'>
                      <table class='table' width='100%' cellpadding='0'>
                          <tr>
                              <td class='CellHead2' colspan='7' align='center'><b>INDICADOR TIEMPO A SOLUCI&Oacute;N DE NOVEDADES COMPRENDIDO ENTRE $datos->fec_inicia y $final </b></td>
                          </tr>
                          <tr  align='center'>
    ...
    private function getDiferencia($fec_inicia, $fec_finali) {
        ...
        while ($fecha <= $ffinal) {
            ...
            {#si no es día festivo 
              ...
              /*$hor_inicia = date("H:i:s", strtotime($hor_inicia));
              $hor_finali = date("H:i:s", strtotime($hor_finali));*/

              if($mFecInicia[0] == $mFecFinali[0]){
              ...
              }else if($mFecInicia[0] == $fecha && $hor_finali >= $mFecInicia[1]){
                  $tiempo += diffHours($mFecInicia[1], $hor_finali);

              }else if($fecha == $mFecFinali[0] && $hor_finali >= $mFecFinali[1] && $hor_inicia <= $mFecFinali[1]){
                 $tiempo += diffHours($hor_inicia, $mFecFinali[1]);
              }else if($fecha == $mFecFinali[0] && $hor_inicia > $mFecFinali[1]){
                 $tiempo += 0;
              }
              /*else{
                 echo "if9<br>";
                 echo $fec_inicia."---".$fec_finali ."<br>";
