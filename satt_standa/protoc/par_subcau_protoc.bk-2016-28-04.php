...
class ModuloComunicaciones
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/par_subcau_protoc.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../".DIR_APLICA_CENTRAL."/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "PARAMETRIZAR SUBCAUSAS", "formulario" );
		echo "<td>";
