...
class InsEvent
{
  ...
  echo '<tr><td><div id="AplicationEndDIV"></div>
   ...
   function registrar()
    {		
        ...
        $this -> conexion = new Conexion( "bd10.intared.net:3306", $_SESSION[USUARIO], $_SESSION[CLAVE], $BASE  );
        $usuario = $_SESSION["datos_usuario"]["cod_usuari"];
        $error = 0;
  ...
  function protocolo()
 {
    ...
    include ("../lib/mensajes_lib.inc");
		echo "<script language=\"JavaScript\" src=\"../".DIR_APLICA_CENTRAL."/js/functions.js\"></script>\n";
		$this -> conexion = new Conexion( "bd10.intared.net:3306", $_SESSION[USUARIO], $_SESSION[CLAVE], $BASE  );//cod_transp
  ...
  $proceso = new InsEvent($_SESSION['conexion'], $_SESSION['usuario_aplicacion'], $_SESSION['codigo']);
