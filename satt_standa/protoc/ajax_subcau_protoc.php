  ...
  protected function MainLoad( $mData )
  {
    ...
    $mHtml  = '<center>';
      ...
      $mHtml  .= '<table width="100%" cellspacing="2px" cellpadding="0">';
        $mHtml .= '<tr>';
          $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i>Subcausas Para Asignar a los Protocolos</i></td>';
        $mHtml .= '</tr>';
      $mHtml .= '</table>';
      ...
      $mHtml .= '<br><div class="Style2DIV">';
        $mHtml .= '<table width="100%" cellspacing="1" cellpadding="0">';
          ...
          $fSelect =  '<select name="cod_tipoxx" id="cod_tipoxxID" onchange="SetForm( $(this), $(\'#formHtmlID\') );" >';
      ...
      $mHtml .= '<br><br><br><span style="font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;"><b>ATENCI&Oacute;N:</b>&nbsp;<i>PARA ELIMINAR UNA SUBCAUSA HAGA CLIC SOBRE EL CONSECUTIVO</i></span><div id="DynamicID">';
