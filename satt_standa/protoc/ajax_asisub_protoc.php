...
class AjaxParametrizar {
    ...
    protected function MainLoad($mData) {
      ...
      echo ".";
        ...
        $mHtml .= '<tr>';
        $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i><b>SELECCI&Oacute;N DE PROTOCOLO</b></i></td>';
        $mHtml .= '</tr>';
        $mHtml .= '</table>';
        ...
        $mHtml .= '<br><br><div id="DynamicID" style="display:none;"><span style="font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;">SELECCIONE LAS SUBCAUSAS QUE DESEA AGREGAR AL PROTOCOLO</span>';
        ...
        #$mHtml .= '<br><br><div id="DynamicaID" style="display:none;"><span style="font-family:Times New Roman; font-size:12px; font-weight:bold; padding-bottom:5px; color: #285C00;">SELECCIONE LAS Verificaciones</span>';
