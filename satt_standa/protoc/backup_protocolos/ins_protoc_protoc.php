...
class InsertProtocolo
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/InsertProtocolo.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    $this -> Style();
    $formulario = new Formulario ( "index.php", "post", "PROTOCOLOS", "formulario" );
...
$centro = new InsertProtocolo( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
