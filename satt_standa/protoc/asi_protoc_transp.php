...
class AsignaProtocolo
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/LoadTranspProtoc.js' ></script>\n";
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "ASIGNACIÓN DE PROTOCOLOS A TRANSPORTADORA", "formulario" );
		echo "<td>";
    ...
    $formulario->oculto("transp\" id=\"transpID\"", '', 0);
		...
		echo "<tr>";
		echo "<td class='celda_titulo2' style='padding:4px;' width='100%' colspan='4' >Transportadora</td>";
		echo "</tr>";
		echo "<tr>";
    $readonly = ''; 
...
$protocolo = new AsignaProtocolo( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
