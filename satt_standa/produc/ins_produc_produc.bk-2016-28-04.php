...
class Productos
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/Productos.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    $this -> Style();
    $formulario = new Formulario ( "index.php", "post", "PRODUCTOS", "formulario" );
...
$_PROC = new Productos( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo  );
