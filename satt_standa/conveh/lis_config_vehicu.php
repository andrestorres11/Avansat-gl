...
// *****************************************************
 function Buscar()
 {
   ...
   $formulario = new Formulario ("index.php","post","Bucar y Listar Configuración de Vehiculos","form_act");
...
// *****************************************************
 function Datos()
 {
  ...
  $inicio[0][1]='-';
   ...
   $formulario = new Formulario ("index.php","post","Listado de Configuraciones","form_item");
   $formulario -> nueva_tabla();
   ...
   echo "<td class=\"celda\"><b>Estado</b></td><td class=\"celda2\">".$matriz[0][2]."</td></tr><tr>";
   echo "<td class=\"celda\"><b>Peso Tn</td></b><td class=\"celda2\">".$matriz[0][4]."</td></tr><tr>";
...
// *********************************************************************************
   ...
   $proceso = new Lis_config_vehicu($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
?>