...
function Buscar()
 ...
 function Datos()
 {
   ...
   $query = "SELECT a.cod_conduc
   		      ...
   		      WHERE a.cod_conduc = '".$_REQUEST[conduc]."'
   		    ";
 ...
 function Eliminar()
 {
  ...
  {
   $link_a = "<br><b><a href=\"index.php?&window=central&cod_servic=".$_REQUEST[cod_servic]." \"target=\"centralFrame\">Eliminar Otro Conductor</a></b>";
