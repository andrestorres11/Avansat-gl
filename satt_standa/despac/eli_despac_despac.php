...
class Proc_despac
{
 ...
 function Eliminar()
 {
  ...
  {
   $link_a = "<br><b><a href=\"index.php?&window=central&cod_servic=".$GLOBALS[cod_servic]." \"target=\"centralFrame\">Eliminar Otro Despacho</a></b>";

   $mensaje =  "El Despacho # <b>".$GLOBALS[despac]."</b> Se Elimino con Exito".$link_a;
   $mens = new mensajes();
