            ...
            if( sizeof($mIntegradorGPS) > 0 )
            {
                ...
                {   
                    ...
                    $mDesGPS = $mHubGPS -> setTrakingEnd([
                                                          ...
                                                          'obs_cierre' => 'Cierre por llegada del despacho 2 '.$usuario,
                                                          ]);
        ...
        $mScript2 = '
              ...
              function InsertInPAD(data,name,api_url) {
                ...
                if (isChecked == true){
                    Swal.fire({
                        title: "Estas seguro?",
                        text: "Habilitaci�n de disponibilidad del recurso a Pad.",
                        icon: "warning",
                        html: "<p><b>1.</b> El conductor autoriza habilitar su datos para recibir informaci�n de central pad?</p><input type=\'checkbox\' id=\'inf_pad\' /><label>Si</label><br>" +
                ...
                $mScript6 = '
                                jQuery(function($) { 
                                    ...
                                    function updateVisualContent() {
                                        ...
                                        // Quitar la última coma y espacio, y actualizar el contenido del contenedor visual
                                        if (content.length > 0) {
