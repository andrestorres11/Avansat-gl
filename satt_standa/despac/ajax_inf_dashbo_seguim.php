...
class AjaxDashBoard_Seguim
{
    ...
    private static  $cHoy,$cTime = array( 'ind_desurb' => '30', 'ind_desnac' => '60' );
        ...
        private function getGrafic1(){
            ...
            $results_=array();
             ...
             where c.cod_transp in (".$_REQUEST[cod_transp].")  
    ...
    private function getGrafic10()
    {
        ...
        foreach($mResult as $value){
            $mSql2="select if(cod_operad is not null,'no','si') as estado from ".BASE_DATOS.".tab_interf_parame where cod_transp='".$value['cod_transp']."' and cod_operad =53";
