...
class Proc_trayle
{
 ...
 function Detalle()
 {
  ...
  $query = "SELECT a.num_trayle
  		     ...
  		     WHERE a.num_trayle = '".$GLOBLAS[trayle]."'
  		   ";
  ...
  $formulario = new Formulario ("index.php","post","ELIMINAR REMOLQUE","form_trayle");
  ...
  if(!$existveh && !$existdes)
   ...
   $formulario -> linea("No se Puede Eliminar el Remolque, Este se Encuentra Relacionado a un Vehiculo &oacute; Despacho.",1,"e");
