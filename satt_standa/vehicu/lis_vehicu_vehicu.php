...
class Lis_vehicu_vehicu
{
 ...
 function Resultado()
 {
  ...
  $formulario = new Formulario ("index.php","post","LISTADO DE VEHICULOS","form_item");
    ...
    $_URL .= !empty($GLOBALS[por_fecha])  ? "&por_fecha=".$GLOBALS[por_fecha] : '';
    $_URL .= !empty($GLOBALS[marcax])     ? "&marcax=".$GLOBALS[marcax] : '';
    $_URL .= !empty($GLOBALS[carroc])     ? "&carroc=".$GLOBALS[carroc] : '';
    $_URL .= !empty($GLOBALS[colorx])     ? "&colorx=".$GLOBALS[colorx] : '';
    $_URL .= !empty($GLOBALS[config])     ? "&config=".$GLOBALS[config] : '';
    $_URL .= !empty($GLOBALS[por_modelo]) ? "&por_modelo=".$GLOBALS[por_modelo] : '';
    $_URL .= !empty($GLOBALS[mod1]) ? "&mod1=".$GLOBALS[mod1] : '';
    $_URL .= !empty($GLOBALS[mod2]) ? "&mod2=".$GLOBALS[mod2] : '';
