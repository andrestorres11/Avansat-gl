<?php
/*! \file: ins_report_report.php
 *  \brief: Inserta los reportes de novedad
 *  \author: 
 *  \author: 
 *  \version: 1.0
 *  \date: dd/mm/aaaa
...
class Reporte {
    ...
    /*! \fn: getInterfData
     *  \brief: Retorna usuario y contraseña
     *  \author: 
     *  \date: dd/mm/aaaa
     *  \date modified: dd/mm/aaaa
     *  \param: cod_tercer
    ...
    /*! \fn: getNomContro
     *  \brief: Retorna el nombre del puesto de control dado el codigo
     *  \author: 
     *  \date: dd/mm/aaaa
     *  \date modified: dd/mm/aaaa
     *  \param: cod_contro
    ...
    /*! \fn: getCodManifiFromPlacax
     *  \brief: Retorna el codigo del manifiesto buscando por la placa un despacho que este en ruta
     *  \author: 
     *  \date: dd/mm/aaaa
     *  \date modified: dd/mm/aaaa
     *  \param: num_placax
    ...
    function sendNovedaIntracarga($sendData, $aditionalData) {
        try {
            ...
            $url_webser = "https://" . URL_DIREC_APLICA . "/interf/app/faro/wsdl/faro.wsdl";
     ...
     *  \return: array
     */
    private function getTranspActivas() {
    ...
    /*! \fn: Formulario
     *  \brief: Formulario para registrar las novedades
     *  \author: 
     *  \date: dd/mm/aaaa
     *  \date modified: dd/mm/aaaa
     *  \param: 
    ...
    function Formulario() {
        ...
        $transpor = $this->getTranspActivas();
