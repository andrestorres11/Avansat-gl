...
class Ins_config_emptra {
    ...
    function filtro() {
		...
		$mHtml -> SetBody(' <script src="../'.DIR_APLICA_CENTRAL.'/js/ajax_transp_transp.js?v=001"></script> ');
    ...
    function filtro_ant() {
		...
		#</div>
					 ...
					 $mHtml->Hidden(array( "name" => "cod_servic", "id" => "cod_servicID", 'value'=>$_REQUEST['cod_servic']));
					 $mHtml->Hidden(array( "name" => "opcion", "id" => "opcionID", 'value'=>''));
					 $mHtml->Hidden(array( "name" => "transp['cod_tercer']", "id" => "cod_tercerID", 'value'=>''));
					 $mHtml->Hidden(array( "name" => "transp['abr_tercer']", "id" => "abr_tercerID", 'value'=>''));
      	...
      	$mHtml->Hidden(array( "name" => "Ajax", "id" => "Ajax", 'value'=>"on"));
	   				...
	   				$mHtml->OpenDiv("id:sec1;");
	    				$mHtml->OpenDiv("id:form1; class:contentAccordionForm");
	    					$mHtml->Table("tr");
						        ...
						        $mHtml->Label(utf8_encode("Nombre o Raz�n Social:"), "width:25%; *:1;");
								...
								$mHtml->Select2 (array(),  array("name" => "emptra[cod_consec]",  "obl" => "1", "id" => "cod_consecID", "width" => "25%", "key"=> $datos->principal->cod_consec,"end" => true) );						        
						        ...
						        $mHtml->Label(utf8_encode("Direcci�n:"), "width:25%; *:1;");
								...
								$mHtml->Label(utf8_encode("C�digo de Empresa:"), "width:25%; :1;");
	        ...
	        $mHtml->OpenDiv("id:DatosSecundariosID; class:accordion");
	    		...
	    		$mHtml->OpenDiv("id:sec2");
	    			$mHtml->OpenDiv("id:form2; class:contentAccordionForm");
	    				$mHtml->Table("tr");
	    					$mHtml->Label(utf8_encode("Distribuci�n:"), "width:25%; :1;");
	        	...
	        	$mHtml->OpenDiv("id:sec2");
	        		$mHtml->OpenDiv("id:form2; class:contentAccordionForm");
	        			$mHtml->Table("tr");
							...
							$mHtml->Label(utf8_encode("Nro Habilitaci�n Nacional:"), "width:25%; :1;");
					        ...
					        $mHtml->Label(utf8_encode("Fecha Resoluci�n (AAAA-MM-DD):"), "width:25%; :1;");
					        ...
					        $mHtml->Label(utf8_encode("C�digo Regional:"), "width:25%; :1;");
					        ...
					        $mHtml->Label(utf8_decode("Nro de Resoluci�n:"), "width:25%; :1;");
	        ...
	        $mHtml->OpenDiv("id:DatosSecundariosID; class:accordion");
	    		...
	    		$mHtml->OpenDiv("id:sec2");
	    			$mHtml->OpenDiv("id:form2; class:contentAccordionForm");
	    				$mHtml->Table("tr");
	    					$mHtml->Label(utf8_encode("Certificaci�n ISO:"), "width:25%; :1;");
					        ...
					        $mHtml->Label(utf8_encode("Certificaci�n BASC:"), "width:25%; :1;");
	        	...
	        	$mHtml->OpenDiv("id:sec2");
	        		$mHtml->OpenDiv("id:form2; class:contentAccordionForm");
	        			$mHtml->Table("tr");
					        ...
					        $mHtml->Label(utf8_encode(" Tel�fono:"), "width:25%; *:1;");					        $mHtml->Input(array("type" => "numeric", "validate" => "numero", "obl" => "1", "minlength" => "7", "maxlength" => "10", "name" => "agencia[tel_agenci]", "id" => "tel_agenci", "width" => "25%", "value" => $datos->principal->tel_agenci, "end" => true));
