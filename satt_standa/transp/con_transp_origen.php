...
class OrigenTransportadora
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/con_transp_origen.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../".DIR_APLICA_CENTRAL."/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "CONFIGURAR ORIGENES A TRANSPORTADORA", "formulario" );
    echo "<td>";
...
$centro = new OrigenTransportadora( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
