    ...
    if(!$tercero){
         ...
         $insercion = new Consulta($query, self::$cConexion, "R");
          ...
          if ($consulta = new Consulta("COMMIT", self::$cConexion)) {
              $link_a = "<br><b><a href=\"index.php?&window=central&cod_servic=" . $GLOBALS[cod_servic] . " \"target=\"centralFrame\"><font style='color:#3F7506'>Insertar Otra Transportadora</font></a></b>";
    ...
    private function modificar($operacion = null, $cod_agenci = null){
       ...
       $query = "UPDATE ".BASE_DATOS.".tab_tercer_emptra
        ...
        $query = "DELETE FROM ".BASE_DATOS.".tab_emptra_modali 
                        WHERE cod_emptra = '$agencia->cod_tercer'";
        $insercion = new Consulta($query, self::$cConexion, "R");
