...
class trans {
     ...
     *  \author: Ing. Cristian Andr閟 Torres
     *  \date: 29/10/2021
     *  \date modified: 
     *  \param: 
     *  \param: 
     ...
     *  \brief: funcion que extrae los datos de una transportadora de la base de datos para su visualizaci贸n o edici贸n
     *  \author: Ing. Alexander Correa
     *  \date: 01/09/2015
     *  \date modified: dia/mes/a帽o
    ...
    private function registrar() {
        ...
        if (!$tercero) {
            ...
            $this->modificar("Registr贸", $nuevo_consec);
        }
    }

    /*     * ****************************************************************************
     *  \fn: activar                                                              *
     *  \brief: funci贸n para activar una transportadora                           *
     *  \author: Ing. Alexander Correa                                            *
     *  \date: 07/09/2015                                                         *
     *  \date modified:                                                           *
     *  \param:                                                                   *
    ...
    private function activar() {
        ...
        if ($consulta = new Consulta("COMMIT", self::$cConexion)) {
            $mensaje = "Se activ贸 la Transportadora " . $transp->abr_tercer . " exitosamente.";
            $mensaje .= "<br><br><input type='button' name='cerrar' id='closeID' value='cerrar' onclick='closed()' class='crmButton small save ui-button ui-widget ui-state-default ui-corner-all'/><br><br>";
            $mens = new mensajes();
    ...
    /*     * ****************************************************************************
     *  \fn: inactivar                                                              *
     *  \brief: funci贸n para inactivar una transportadora                           *
     *  \author: Ing. Alexander Correa                                            *
     *  \date: 07/09/2015                                                         *
     *  \date modified:                                                           *
     *  \param:                                                                   *
    ...
    private function inactivar() {
        ...
        if ($consulta = new Consulta("COMMIT", self::$cConexion)) {
            $mensaje = "Se inactiv贸 la Transportadora " . $transp->abr_tercer . " exitosamente.";
            $mensaje .= "<br><br><input type='button' name='cerrar' id='closeID' value='cerrar' onclick='closed()' class='crmButton small save ui-button ui-widget ui-state-default ui-corner-all'/><br><br>";
            $mens = new mensajes();
    ...
    /*     * ****************************************************************************
     *  \fn: modificar                                                            *
     *  \brief: funci贸n para modificar una transportadoras                        *
     *  \author: Ing. Alexander Correa                                            *
     *  \date: 07/09/2015                                                         *
     *  \date modified:                                                           *
     *  \param:                                                                   *
    ...
    private function modificar($operacion = null, $cod_agenci = null) {
        ...
        # lleno los objetos nesesarios para la correcta modificaci贸n en la base de datos.
        $transp = (object) $_POST['transp']; //objeto para llenar la tabla tab_tercer_tercer
        $emptra = (object) $_POST['emptra']; //objeto para llenar la tabla tab_tercer_emptra
        $agencia = (object) $_POST['agencia']; //objeto para llenar la tabla tab_genera_agenci
        $modali = (object) $_POST['modali']; //para las modalidades de la transportadora
    ...
    private function getServicesAditionals() {
        ...
        $list->SetClose('no');
        $list->SetHeader(utf8_decode("C贸digo de la transportadora"), "field:a.cod_transp; width:1%;  ");
    ...
    /* ! \fn: inactivarConfig
     *  \brief: inactiva una configuracio贸n registrada de una empresa
     *  \author: Ing. Alexander Correa
     *  \date: 11/07/2016
     *  \date modified: dia/mes/a帽o
     *  \param: 
