<?php
 $nom_cam = isset( $_GET['nom'] ) ? $_GET['nom'] : 0;
?>
...
<script language="javascript">
        function setClose(color){        
                 var nom_cam = '<?php echo $nom_cam;?>';                  
                window.opener.setColor(color,nom_cam);                
                window.close();
        }
</script>
<html>
...
<table border="0" cellpadding="1" cellspacing="0" width="292" align="center">
        ...
        <tr>
                <td colspan="2">
                        <a href="webpal.map">
                                <img src="../imagenes/colorchart.gif" width="292" height="196" border="0" alt="color chart" usemap="#map_webpal" ismap />
                        </a>
                </td>
        </tr>
        <tr>
                <td colspan="2" align="left"><font size="1" face="trebuchetms,verdana,arial">
                        Seleccione un color para identificar los puestos de control EAL.</p>
                </td>
        </tr>
</table>
<map name="map_webpal">
        ...
        <area coords="66,113,82,129" href="javascript:setClose('00CCCC')">
