		...
		if( $mView->fil_genera->ind_visibl == 1 )
		{
			...
			$mHtml1 .= '<div>';
				...
				$mHtml1 .= '<table width="100%" cellspacing="0" cellpadding="0">';
					...
					$mHtml1 .= '<input id="windowID" type="hidden" value="central" name="window">';
					$mHtml1 .= '<input id="standaID" type="hidden" value="'.DIR_APLICA_CENTRAL.'" name="standa">';
					$mHtml1 .= '<input id="ind_filactID" type="hidden" value="" name="ind_filact">';
					$mHtml1 .= '<input id="sel_transpID" type="hidden" value="'.$_REQUEST[cod_transp].'" name="sel_transp">';
					$mHtml1 .= '<input id="sel_usuariID" type="hidden" value="'.$_REQUEST[cod_usuari].'" name="sel_usuari">';
