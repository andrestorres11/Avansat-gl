...
class CanDesTra
{
    ...
    function MostrarResul()
    {
        ...
        if(!$_REQUEST["horaini"]) $_REQUEST["horaini"]='00:00:00';
        if(!$_REQUEST["horafin"]) $_REQUEST["horafin"]='23:59:00';
            ...
            $mHtml  = "<table width='100%'>";
                ...
                foreach($origen AS $row)
                {
                    $mHtml .= "<tr>";
                        ...
                        $mHtml .= "<td class='cellInfo' align='center' onclick=\"infoDetEmp('".$row['cod_ciuori']."','".$transpor['cod_tercer']."','".$_REQUEST['fec_inicial']."','".$_REQUEST['fec_final']."','".$_REQUEST['horaini']."', '".$_REQUEST['horafin']."', 1);\" ><a href='#'>".$row['num_despac']."</a></td>";
                        $mHtml .= "<td class='cellInfo' align='center' >".number_format(($row['num_despac']/$despachos[0]['num_despac'])*100,0)."</td>";
                        $mHtml .= "<td class='cellInfo' align='center' onclick=\"infoDetEmp('".$row['cod_ciuori']."','".$transpor['cod_tercer']."','".$_REQUEST['fec_inicial']."','".$_REQUEST['fec_final']."','".$_REQUEST['horaini']."', '".$_REQUEST['horafin']."', 2);\" ><a href='#'>".sizeof($this -> GetNovedades( $transpor['cod_tercer'], $row['cod_ciuori'], $fec_inici, $fec_final ))."</a></td>";
                    $mHtml .= "</tr>";
                }
                
                $mHtml .= "<tr>";
                    $mHtml .= "<th class=cellHead align='left' >DESPAHOS</th>";
                    $mHtml .= "<th class=cellInfo align='left' colspan=3 onclick=\"infoDetEmp('','".$transpor['cod_tercer']."','".$_REQUEST['fec_inicial']."','".$_REQUEST['fec_final']."','".$_REQUEST['horaini']."', '".$_REQUEST['horafin']."', 1);\" ><a href='#'>".$despachos[0]['num_despac']."</a></th>";
                $mHtml .= "</tr>";
                
                $mHtml .= "<tr>";
                    $mHtml .= "<th class=cellHead align='left' >RUTAS CREADAS</th>";
                    $mHtml .= "<th class=cellInfo align='left' colspan=3 onclick=\"infoDetEmp('','".$transpor['cod_tercer']."','".$_REQUEST['fec_inicial']."','".$_REQUEST['fec_final']."','".$_REQUEST['horaini']."', '".$_REQUEST['horafin']."', 3);\" ><a href='#'>".sizeof($this -> GetRutas( $transpor['cod_tercer'], $fec_inici, $fec_final ))."</a></th>";
                $mHtml .= "</tr>";
            $mHtml  .= "</table>";
    ...
    function GetTransporta( $ind = NULL )
    {
        ...
        if($_REQUEST['busq_transp'] && $ind != 2 )
        {
            $v = explode(" - ", $_REQUEST['busq_transp']);
