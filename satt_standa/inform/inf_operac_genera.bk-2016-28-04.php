...
class InformViajes
{
  ...
  function getInform()
  {
    ...
    $mSelect2 .="WHERE t.fec_llegad IS NOT NULL AND 
                       a.fec_despac BETWEEN '".$_REQUEST['fec_inicia']." 00:00:00' AND '".$_REQUEST['fec_finali']." 23:59:59'
                 ";
  ...
  //Inicio Función getDespacContro
