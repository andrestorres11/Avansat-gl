...
class InformeNovedadesTiempos
{
	...
	function getDespachos()
	{
		...
		$select .= "SELECT c.abr_tercer, a.num_despac, b.fec_salida, f.tie_contro
				   ...
				   WHERE a.num_despac = b.num_despac AND
						 ...
						 e.cod_transp = f.cod_transp AND
						 f.cod_tipser = 3 AND
						 DATE( a.fec_creaci ) BETWEEN '$_POST[fec_inicia]' AND '$_POST[fec_final]' ";
	...
	{
		/*$select = "SELECT g.nom_contro, a.fec_noveda, 'NOVEDAD', a.usr_creaci, a.fec_creaci
				   FROM ".BASE_DATOS.".tab_despac_noveda a,
						".BASE_DATOS.".tab_despac_despac b,
						".BASE_DATOS.".tab_tercer_tercer c,
						".BASE_DATOS.".tab_despac_seguim d,
						".BASE_DATOS.".tab_despac_vehige e,
						".BASE_DATOS.".tab_transp_tipser f,
						".BASE_DATOS.".tab_genera_contro g
				   WHERE a.num_despac = b.num_despac AND
						 e.cod_transp = c.cod_tercer AND
						 a.num_despac = d.num_despac AND
						 a.cod_contro = d.cod_contro AND
						 ...
						 a.cod_contro = g.cod_contro AND
						 DATE( a.fec_creaci ) BETWEEN '$_POST[fec_inicia]' AND '$_POST[fec_final]' ";
		*/
		
		/*----------NUEVO QUERY PARA LA OBTENCIÓN DE NOVEDADES SEGÚN DESPACHO----------*/
...
//$service= new  InformeNovedadesTiempos($this->conexion);
