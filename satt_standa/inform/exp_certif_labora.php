...
class CertifLaboral
{
 ...
 function searchTercer()
 {
    ...
    $query = " SELECT UPPER( CONCAT(IF( a.num_cedula IS NULL , '00000000', a.num_cedula ) ,' - ',a.nom_usuari) ) AS nom_tercer
                 FROM ".BASE_DATOS.".tab_genera_usuari a  
 ...
 function getCertif()
 {
    ...
    $parametros =  array( "nom_aplica" => "c_intrared", 
    ...
    $oSoapClient = new nusoap_client( "https://web1.intrared.net/ap/interf/app/consultor/wsdl/consultor.wsdl" , true );
    ...
    if ( $oSoapClient -> fault )
    {
       ...
       echo "<pre>"; print_r( $oSoapClient -> faultcode.':'.$oSoapClient -> faultdetail.':'.$oSoapClient -> faultstring ); echo "</pre>";
    }
    else
    {
