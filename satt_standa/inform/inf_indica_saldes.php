              ...
              <div id="contenido">
                <div  class="Style2DIV">
                  <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        <th class="CellHead centrado" colspan="6" ><label id="notify"><b>Ingrese los  Par&aacute;metros de consulta</b></label></th>
                    </tr>
                    <tr class="Style2DIV">
                      <td class="contenido centrado" colspan="6" >
                        <div class="col-md-12">
                          <?php if($total > 1){ ?>
                            <div class="col-md-3 derecha" >Transportadora<font style="color:red">*</font>: </div>
                            <div class="col-md-3 izquierda" ><input class="ancho" type="text" id="nom_transpID" name="nom_transp" ></div>
                            <?php } ?>
                            <div class="col-md-3 derecha">Ciudad Origen:</div>
                            <div class="col-md-3 izquierda" id="origenes"><b>Ingrese Primero una Transportadora</b></div>
                        </div>
                        ...
                        <div class="col-md-2 ">Tipo de Transporte:</div>
                        <div class="col-md-2 izquierda">
                            <select id="tip_transpID" name="tip_transp" class="ancho">
                                <option value="">Todos</option>
