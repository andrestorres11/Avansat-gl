  ...
  protected function MainLoad( $mData )
  {
    ...
    $mHtml  = '<center>';
      ...
      $mHtml  .= '<table width="100%" cellspacing="2px" cellpadding="0">';
        $mHtml .= '<tr>';
          $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i>NUEVO RECOMENDADO</i></td>';
        $mHtml .= '</tr>';
      $mHtml .= '</table>';
      ...
      $mHtml .= '<br><br><br><span style="font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;"><b>ATENCI&Oacute;N:</b>&nbsp;<i>PARA EDITAR O ELIMINAR UN RECOMENDADO HAGA CLIC SOBRE EL CONSECUTIVO</i></span><div id="DynamicID">';
  ...
  protected function SetForm( $mData )
  {
    ...
    switch( (int)$mData['sel'] )
    {
      case 1:
        ...
        $mHtml  .= '<table width="100%" cellspacing="2px" cellpadding="0">';
          $mHtml .= '<tr>';
            $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i>Boceto del Elemento dentro del Formulario</i></td>';
          $mHtml .= '</tr>';
        $mHtml .= '</table><br><br>';
      ...
      case 2:
        $mHtml  .= '<table width="100%" cellspacing="2px" cellpadding="0">';
          $mHtml .= '<tr>';
            $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i>Datos a Ingresar</i></td>';
          $mHtml .= '</tr>';
        $mHtml .= '</table><br><br>';
      ...
      case 3:
        $mHtml  .= '<table width="100%" cellspacing="2px" cellpadding="0">';
          $mHtml .= '<tr>';
            $mHtml .= '<td colspan="4" style=" text-align:center;border-bottom:1px solid #000000; font-family:Times New Roman; font-size:11px; font-weight:bold; padding-bottom:5px; color: #285C00;" ><i>Unidad de Medida</i></td>';
          $mHtml .= '</tr>';
        $mHtml .= '</table><br><br>';
