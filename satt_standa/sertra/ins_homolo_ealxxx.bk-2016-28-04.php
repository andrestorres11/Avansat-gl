...
//********METODOS
 ...
 function Insertar()
 {
   ...
   {
     $link_a = "<br><b><a href=\"index.php?&window=central&cod_servic=".$GLOBALS[cod_servic]." \"target=\"centralFrame\">Homologar los puestos de control fisicos de otra transportadora</a></b>";

     $mensaje =  "Se realiz&oacute; la homologaci&oacute;n de los puestos de control fisicos para la transportadora <b>".$GLOBALS[cod_transp]." - ".$GLOBALS[nom_transp]."</b> con &Eacute;xito".$link_a;
     $mens = new mensajes();
