 ...
 */
    ...
    class ins_sertra_sertra{
        ...
        function showFilters(){
            ...
            <script type="text/javascript" language="JavaScript" src="../<?= DIR_APLICA_CENTRAL ?>/js/mask.js"></script>
                      ...
                      <table width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tr class="Style2DIV">
                          <td class="contenido" colspan="6" style="text-align:center">
                            ...
                            <input type="hidden" name="option" value="showFilters">
                          </td>
                        </tr>
                    </table>
                    </div>
            ...
            <div id="form3" class="col-md-12 ancho" style="display:none"></div>            
