<?php
	...
	****************************************************************************/
      private function scripts(){
          ...
          echo '
              ...
              <script src="../' . DIR_APLICA_CENTRAL . '/js/inf_transp_tipser.js"></script>
          ';
      }
                                  ...
                                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                      <div class="card-body">
                                          <form action="'.$_SERVER['PHP_SELF'].'" id="filter" name="filter" method="POST">
                                              ...
                                              <div class="row mt-2">
                                                  <div class="col-2 text-right">
                                                      <label>Horario de S:</label>
                                                  </div>
                                                  <div class="col-2">
                                                      <input type="radio" name="optradio" value="1" checked>
                                                  </div>
                                                  <div class="col-2 text-right">
                                                      <label>Tiempo de S:</label>
                                                  </div>
                                                  <div class="col-2">
 ...
 new InfTipoServicio($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
