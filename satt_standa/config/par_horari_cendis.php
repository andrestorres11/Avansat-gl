<?php
/*! \file: par_horari_cendis.php
 *  \brief: Formulario para parametrizar los horarios laborales de los centros de distribucion por transpotadora
...
/*! \class: HorarioCentroDistri
 *  \brief: Crea formulario para parametrizar horarios laborales del centro de distribucion por transportadora
 */
class HorarioCentroDistri
{
  var $conexion,
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/par_indica_solnov.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../".DIR_APLICA_CENTRAL."/estilos/jquery.css' type='text/css'>";

    $formulario = new Formulario ( "index.php", "post", "PARAMETRIZAR HORARIO CENTRO DE DISTRIBUCION", "formulario" );
		echo "<td>";
    ...
    { 
      ...
      $readonly = 'readonly="readonly" value="'.$TRANSP[0][0].' - '.$TRANSP[0][1].'"';
		...
		echo "<td class='celda_titulo' style='padding:4px;' width='50%' >
				    <input class='campo_texto' type='text' size='35' name='cod_transp' id='cod_transpID' ".$readonly."/>
          </td>";
    echo "<td class='celda_titulo' style='padding:4px;' width='50%' align='right' >
            Centro de Distribuci&oacute;n: 
          </td>";
    echo "<td id='ciudadTD' class='celda_titulo' style='padding:4px;' width='50%' ></td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td  class='celda_etiqueta' style='padding:4px;' align='center' colspan='4' >
        <input type='hidden' name='ind_config' id='ind_configID' value='2'>
				<input class='crmButton small save' style='cursor:pointer;' type='button' value='Generar' onclick='ValidateTransp(2);'/></td>";
		echo "</tr>";
		echo "</table></td>";
		$formulario -> cerrar();
...
$centro = new HorarioCentroDistri( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo );
