  ...
  */
  private function setRegistros() {
    $mSql = " SELECT a.num_remdes, 
                    IF(((b.nom_tercer='') OR (b.nom_tercer IS NULL) OR (b.cod_tercer = '')),'NOTIFICACIÃ“N FARO',b.nom_tercer),  
                    a.dir_emailx,  
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <select class="form-control" id="cliente" name="cliente">
                                <option value="" style="background-color:#dff0d8; color:#3c763d">NOTIFICACIÃ“N FARO</option>
