...
class LisStanda
{
        ...
        echo "<script language=\"JavaScript\" src=\"../".DIR_APLICA_CENTRAL."/js/tarifa.js\"></script>\n";
			  ...
			  echo '
			   <script>
				...
				$formulario = new Formulario("index.php\" enctype=\"multipart/form-data\"", "post", "LISTAR TARIFAS STANDA", "form\" id=\"formularioID");
    ...
    function listar()
    {
        ...
        $list->SetClose('no');
        $list->SetHeader("Consecutivo", "field:cod_tarifa; type:link; onclick:infoTarifa()");
    ...
    $formulario -> nueva_tabla();
		...
		$formulario -> linea($tarifa[0][5],1,"t");
		$formulario -> linea("Fecha de Facturacion Final",0,"t2");
		$formulario -> linea($tarifa[0][6],0,"t");
...
$service = new LisStanda($_SESSION['conexion'], $_SESSION['usuario_aplicacion'], $_SESSION['codigo']);
?> 
