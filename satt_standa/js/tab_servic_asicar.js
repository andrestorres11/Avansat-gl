...
$(function() {
    ...
    var table = $("#contenedor #tablaRegistros").DataTable({
        "ajax": {
            "url": "../" + standa + "/serasi/ajax_servic_asicar.php",
...
function almacenarDatos() {
    ...
    $.ajax({
        url: "../" + standa + "/serasi/ajax_servic_asicar.php?" + dataString,
        method: 'POST',
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "../" + standa + "/serasi/ajax_servic_asicar.php",
                    type: "post",
                    data: ({ option: 'updEst', estado: $(objet).attr('data-estado'), cod_servicasi: $(objet).val() }),
                    dataType: "json",
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Cargando',
