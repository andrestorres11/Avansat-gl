function aceptar_insert(formulario)
{
    ...
    {
     window.alert("El Tipo de Empaque del Ministerio es Requerido")
    ...
    else if(confirm('Esta Seguro de Insertar el Tipo de Empaque ? '))
    {
...
function aceptar_update(formulario)
{
    ...
    else if(confirm('Esta Seguro de Actualizar el Tipo de Empaque ? '))
    {
...
function aceptar_lis(formulario)
{
    ...
    {
     window.alert("El Tipo de Empaque es Requerida")
     validacion = false
    }
    else
    {
