...
function detalle(cod_operac, fec_inicia, fec_finali, tipo_consulta){
	...
	var formData = "Option=GetDetalle&Ajax=on&cod_operac="+cod_operac+"&fec_inicia="+fec_inicia+"&fec_finali="+fec_finali+"&tipo="+tipo_consulta+"&fecha_inicial="+fecha_inicial+"&fecha_final="+fecha_final;
	var standa = $("#standaID").val();
	//cierra popUp si hay inicialiado
	LoadPopupJQNoButton('close');
	//valido los datos generales del formulario
