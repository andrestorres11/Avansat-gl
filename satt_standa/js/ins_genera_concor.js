 ...
 *  \brief: permite visualizar correctamente las vistas en ins_genera_concor.php ademas de realizar algunas funciones ajax
...
$(function() {
    ...
    var table = $("#contenedor #tablaRegistros").DataTable({
        "ajax": {
            "url": "../" + standa + "/config/ajax_genera_concor.php",
...
function validateFields(field = null) {
    ...
    if (!validaciones()) {
        if (field == null) {
            ...
            $(".inc_alert").each(function() {
                if ($(this).siblings().attr("cod_concor") != $(field).attr("cod_concor")) {
                    $(this).remove();
            ...
            $(".validate").each(function() {
                if ($(this).attr("cod_concor") == $(field).attr("cod_concor")) {
                    if ($(this).siblings().attr("cod_concor") == undefined) {
