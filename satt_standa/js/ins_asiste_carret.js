    ...
    if(valor.value==1){
          ...
          <div class="row">
            <div class="offset-1 col-3">
              ...
              <div class="col-3">
                ...
                <div class="row mt-3">
                  <div class="offset-1 col-3">
                    <input class="form-control form-control-sm" type="text" placeholder="Contrase�a" id="con_vehicuID" name="con_vehicu">
                    </div>
                    <div class="col-4">
                      <input class="form-control form-control-sm" type="text" placeholder="Ubicaci�n" id="ubi_vehicuID" name="ubi_vehicu">
                      </div>
                      <div class="col-3">
                      ...
                      <div class="row mt-3">
                        <div class="offset-1 col-10">
                          <textarea class="form-control" id="des_asisteID" name="des_asiste" rows="3" placeholder="Breve Descripci�n de la Asistencia"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>`);
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <input class="form-control form-control-sm" type="text" placeholder="Direcci�n" id="dir_ciuoriID" name="dir_ciuori" required>
          </div>
        </div>
        ...
        <div class="row mt-3">
          ...
          <div class="col-4">
            <input class="form-control form-control-sm" type="text" placeholder="Direcci�n" id="dir_ciudesID" name="dir_ciudes" required>
          </div>
        </div>
