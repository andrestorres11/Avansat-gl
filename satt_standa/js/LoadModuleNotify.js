...
#        AJAX del módulo 'Centros de Operacion'                 -----                                          
#------------------------------------------------------------------*/
...
$(document).ready(function() 
{
  ...
  $( "#cod_transpID" ).autocomplete({
    source: "../"+ Standa +"/centro/ajax_centro_notifi.php?option=getTransp&standa="+Standa+"&filter="+filter,
    minLength: 2, 
    delay: 100
  });
...
{  
  try
  {
    ...
    attribs += '&contact_id=' + contact_id;
      ...
      $.ajax({
        url: "../"+ Standa +"/centro/ajax_centro_notifi.php",
        data : attribs,
        method : 'POST',
        beforeSend : 
          function () 
...
function Manage( option, id_notify )
{
  ...
  try
  {
    ...
    $("#PopUpID").dialog({
        ...
        resizable : false,
        draggable: false,
        title: title_popup + " de Centro de Operaci\xf3n",
