            ...
            $.ajax({
                ...
                success: function(datos) {
                    if (datos == '1') {
                        ...
                        swal({
                            title: "Parametrizaci�n",
                            text: "Todos los d�as ya parametrizados.",
                            type: "warning"
                        });
                    } else {
                        $("#PopUpID").html(datos);
                    ...
                    success: function(datos) {
                        ...
                        if (datos == '9999') {
                            swal({
                                ...
                                text: "Atenci�n esta fecha ya esta configurada como festivo.",
                                type: "warning"
                            });
                        } else if (datos == '1991') {
                            swal({
...
function registrarTipoServicio() {
    ...
    if (conn) {
        ...
        if (tie_trazab) {
            if (isNaN(tie_trazab)) {
                setTimeout(function() {
                    inc_alerta("tie_trazabID", "Solo se aceptan n�meros");
                }, 510);
                val = false;
            } else {
                if (parseFloat(tie_trazab) > 12) {
                    setTimeout(function() {
                        inc_alerta("tie_trazabID", "Rango m�ximo de 12 horas");
                    }, 510);
                    val = false;
                }
            }
        ...
        if (val == true) {
            swal({
                title: "Tipo de Servicio",
                text: "�Realmente Deseas Actualizar la configuraci�n de la transportadora?",
                type: "warning",
                showCancelButton: true,
                closeOnConfirm: false,
                showLoaderOnConfirm: true,
...
function NewParametrizacion(cod_ciudad) {
    ...
    if (conn) {
        ...
        if (contador > 1) {
            swal({
                title: "Parametrizaci�n",
                text: "Solo se pueden seleccionar d�as de una lista.",
                type: "warning"
            });
            errores = true;
        }else{
        ...
        if (nue_combin == "") {
            swal({
                title: "Parametrizaci�n",
                text: "Seleccione por lo menos un d�a de la semana.",
                type: "warning"
            });
            errores = true;
        }
        if (!errores) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $.blockUI({
                        theme: true,
                        title: 'Registrando configuraci�n',
                        draggable: false,
                ...
                success: function(datos) {
                    ...
                    if (datos == '1000') {
                        swal({
                            title: "Parametrizaci�n",
                            text: "Configuraci�n registrada con �xito.",
                            type: "success"
                        });
                        ...
                        swal({
                            title: "Parametrizaci�n",
                            text: "Error al registrar la configuraci�n, por favor intenta nuevamente.",
                            type: "warning"
                        });
                        swal("");
                    }
...
function deleteConfiguracion(cod_transp, dia, ind_config) {
    try {
        swal({
            ...
            text: "�Realmente Deseas eliminar la configuraci�n seleccionada?",
            type: "warning",
            showCancelButton: true,
            closeOnConfirm: false,
            showLoaderOnConfirm: true,
            ...
            $.ajax({
                ...
                success: function(datos) {
                    if (datos == 1) {
                        swal({
                            title: "Eliminar Configuraci�n",
                            text: "Datos eliminados con �xito.",
                            type: "success"
                        }, function() {
                            parameters = getDataForm();
                            mostrar();
    ...
    try {
        ...
        if (conn) {
            ...
            $("#PopUpID").dialog({
                ...
                resizable: false,
                draggable: false,
                title: "Creaci�n de Particularidad",
                width: 800,
                heigth: 500,
                position: ['middle', 25],
                bgiframe: true,
            ...
            $.ajax({
                ...
                success: function(datos) {
                    ...
                    if (datos == '1000') {
                        swal({
                            title: "Parametrizaci�n",
                            text: "Particularidad registrada con �xito.",
                            type: "success"
                        });
                        $("#PopUpID").dialog('close');
                        mostrar();
            ...
            $.ajax({
                ...
                success: function(datos) {
                    ...
                    if (datos == '1000') {
                        swal({
                            title: "Parametrizaci�n",
                            text: "Contacto registrado con �xito.",
                            type: "success"
                        });
                        $("#PopUpID").dialog('close');
                        mostrar();
            ...
            $.ajax({
                ...
                success: function(datos) {
                    ...
                    if (datos == '1000') {
                        swal({
                            title: "Parametrizaci�n",
                            text: "Contacto Actualizado con �xito.",
                            type: "success"
                        });
                        $("#PopUpID").dialog('close');
                        mostrar();
            ...
            $.ajax({
                ...
                success: function(datos) {
                    ...
                    if (datos == '1000') {
                        swal({
                            title: "Parametrizaci�n",
                            text: "Particularidad Actualizada con �xito.",
                            type: "success"
                        });
                        $("#PopUpID").dialog('close');
                        mostrar();
