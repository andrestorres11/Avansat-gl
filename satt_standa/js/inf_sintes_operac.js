    ...
    try {
        ...
        if (date_inicia > date_finali) {
            ...
            $.ajax({
                ...
                data: "option=getInform&cod_transp=" + cod_transp.val() + "&fec_inicia=" + fec_inicia.val() + "&fec_finali=" + fec_finali.val() + "&cod_tipdes=" + cod_tipdes.val() + "&cod_produc=" + cod_produc.val(),
                type: "POST",
                async: true,
