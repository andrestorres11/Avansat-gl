/* ! \file: tab_difere_despac
 *  \brief: permite visualizar correctamente las vistas en tab_difere_despac.php ademas de realizar algunas funciones ajax
...
$(function() {
    ...
    var table = $("#contenedor #tablaRegistros").DataTable({
        "ajax": {
            "url": "../" + standa + "/inform/ajax_difere_despac.php",
...
function almacenarDatos() {
    ...
    $.ajax({
        url: "../" + standa + "/inform/ajax_difere_despac.php?" + dataString,
        method: 'POST',
