      ...
      $.ajax({
        ...
        success: function(datos) {
          ...
          $("input[name^='nom_destinVal']").autocomplete({
            source: "../" + standa + "/desnew/ajax_desnew_despac.php?option=getNomDestin&standa=" + standa,
            minLength: 3,
            delay: 100,
            select: function(event, ui) {
        ...
        success: function(datos) {
          ...
          complete: function(){
            $("#sit_cargueVal").autocomplete({
              source: "../" + standa + "/desnew/ajax_desnew_despac.php?option=getSitCar&standa=" + standa,
              minLength: 3,
              delay: 100,
              select: function(event, ui) {
