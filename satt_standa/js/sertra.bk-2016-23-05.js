...
function onChangeTipServic()
{
    ...
    {  
      document.getElementById('tie_controID').style.display = "none";
      document.getElementById('tie_controID').value = "";
      document.getElementById('tie_conurbID').style.display = "none";
      document.getElementById('tie_conurbID').value = "";
    }
    else 
    {
      document.getElementById('tie_controID').style.display = "";
      document.getElementById('tie_conurbID').style.display = "";
    }
}
