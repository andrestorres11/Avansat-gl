...
/*! \fn: drawNovUpd
 *  \brief: pinta popup del historico de las Novedades
 *  \author: Ing. Miguel Romero
 *	\date: 29/09/2016 
 *  \param: string a dibujar	 
 */


function drawNovUpd(encodedString){

	decodedString = window.atob(encodedString);
	jsonData = JSON.parse(decodedString); 

	html = "<table>";
	html += "<tr bgcolor='#285c00'>"; 
	
	html += "<th><font color='#fff'>Codigo Novedad</font></th>"; 
	html += "<th><font color='#fff'>Nombre Novedad</font></th>"; 
	html += "<th><font color='#fff'>Observacion Novedad</font></th>"; 
	html += "<th><font color='#fff'>Motivo</font></th>";  
	html += "<th><font color='#fff'>Usuario</font></th>"; 
	html += "<th><font color='#fff'>Fecha de creacion</font></th>"; 
	...
	$.each( jsonData ,function( i, o ){
		...
		html += "<tr>";
		html += "<td>"+o.cod_novold+"</td>";
		html += "<td>"+o.nom_noveda+"</td>";
		html += "<td>"+o.obs_novold+"</td>";
		html += "<td>"+o.obs_motivo+"</td>";
		html += "<td>"+o.usr_creaci+"</td>";
		html += "<td width='100'>"+o.fec_creaci+"</td>"; 
		html += "</tr>";
	});
 
	html += "</table>";

	$("<div id='drawNovUpd' title='Novedades Actualizadas'><div class='contentAccordionForm'>"+html+"</div></div>").dialog({ 
		resizable: false,
		draggable: false,
		modal: true,
		width: 800,
