...
class infBandeja
{
	...
	private static $cTipErrorx = array( # son de soporte
										...
										array('288',	 'Creación de Ruta') ,
										array('289',	 'Vehículo Recomendado') ,
										array('290',	 'Actualización de Causas') ,
										array('291',	 'Eliminación de Causas') ,
										array('292',	 'Actas Operativas') ,
										array('293',	 'Análisis general de un Despacho') ,
										array('294',	 'Creación masiva de Usuarios') ,
										array('295',	 'Creación masiva de Rutas') ,
										array('296',	 'Plan de acción correctivas') ,
										array('297',	 'Solicitud de Grabaciones') ,
										array('298',	 'PQR del servicio (Plan de Mejoras)') ,
										array('299',	 'Análisis de Auditorias y (plan de Mejoras)') 
	...
	{	
		...
		$mHtml->OpenDiv("id:accordionID");
			$mHtml->SetBody('<h1 style="padding:6px" class="ui-accordion-header ui-helper-reset ui-state-default ui-state-active ui-corner-top" role="tab" aria-expanded="true" tabindex="0"><b>FILTROS GENERALES</b></h1>');
