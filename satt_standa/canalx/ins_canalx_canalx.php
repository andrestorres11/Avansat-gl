...
class Canales
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/Canales.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/informes.css' type='text/css'>";
    $formulario = new Formulario ( "index.php", "post", "CANALES", "formulario" );
...
$_PROC = new Canales( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo  );
