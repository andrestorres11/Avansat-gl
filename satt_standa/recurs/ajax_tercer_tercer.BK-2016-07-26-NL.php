    ...
    private function listaTerceros($cod_transp){
        $mSql = "SELECT  a.cod_tercer,a.abr_tercer,g.nom_activi,
        				 CONCAT( UPPER(d.abr_ciudad), '(', LEFT(e.nom_depart, 4), ') - ', LEFT(f.nom_paisxx, 3) ) abr_ciudad,
                   		 ...
                   		 IF(a.cod_estado = '1','Activo', 'Inactivo') cod_estado,
                   		 a.cod_estado cod_option
              ...
              WHERE c.cod_activi NOT IN (1,2,4) AND b.cod_transp = '$cod_transp' GROUP BY a.cod_tercer, c.cod_activi";
        ...
        $list->SetHeader(utf8_decode("ACTIVIDAD"), "field:a.nom_activi; width:1%");
        $list->SetHeader(utf8_decode("CIUDAD"), "field:a.abr_ciudad; width:1%");
    ...
    private function modificar($operacion = null){
      ...
      if($activi){
        ...
        $query = "DELETE FROM ".BASE_DATOS.".tab_tercer_activi
                     WHERE  cod_tercer = '$tercer->cod_tercer' AND cod_activi != 1";
