...
*/
    ...
    private function scripts(){
        ...
        echo '
            ...
            <script src="../' . DIR_APLICA_CENTRAL . '/js/inf_operad_gpsxxx.js?rand='.rand(150, 20000).'"></script>
        ';
    }
...
$proceso = new inf_operad_gpsxxx($this -> conexion, $this -> usuario_aplicacion, $this-> codigo);
