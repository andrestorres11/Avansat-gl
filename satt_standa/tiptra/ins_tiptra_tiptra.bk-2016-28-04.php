...
class Tiptra
{
  ...
  private function principal()
  {
    ...
    echo "<script type='text/javascript' src='../".DIR_APLICA_CENTRAL."/js/Tiptra.js' ></script>\n";
    
    echo "<link rel='stylesheet' href='../" . DIR_APLICA_CENTRAL . "/estilos/jquery.css' type='text/css'>";
    $this -> Style();
    $formulario = new Formulario ( "index.php", "post", "Tipo de Transporte", "formulario" );
...
$_PROC = new Tiptra( $this -> conexion, $this -> usuario_aplicacion, $this-> codigo  );
