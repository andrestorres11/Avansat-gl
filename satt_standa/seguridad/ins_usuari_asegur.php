...
class ins_usuari_usuari {
    ...
    function __construct($co, $us, $ca) {
        ...
        <script src="../<?= DIR_APLICA_CENTRAL ?>/js/usuari2.js" language="javascript"></script>
    ...
    function lista() {
        ...
        <form action="index.php" method="post" name="form_search" id="form_searchID" enctype="multipart/form-data">        
            <div class="accordion">
                <h3 style='padding:6px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>LISTADO DE USUARIOS PARA ASEGURADOS</b></h3>
                <div class="" id="sec2">
                    <div class="Style2DIV" id="form3">
        <?php
        echo self::$cFunciones->listaUsuariosAsegurados();
        ?>
                    </div>
                </div>
            </div>            
                            ...
                            <tr>
                                <td style="text-align:center" class="CellHead contenido">
                                    ...
                                    <div class="col-md-12 ancho">
                                        ...
                                        <input type="hidden" name="cod_perfil" id="cod_perfil" value="<?= COD_PERFIL_ASEGURADO ?>" >
