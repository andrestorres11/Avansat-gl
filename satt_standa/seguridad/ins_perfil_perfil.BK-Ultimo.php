...
class ins_perfil_perfil {
    ...
    <div class="accordion"  >
        <h1 style="padding:6px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>INFORMACIÓN BÁSICA DEL PERFIL</b></h1>
        <div id="contenido">
            <div class="Style2DIV">
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align:center" class="CellHead contenido">
                                <div class="col-md-6 text-right">Código<font style="color:red">*</font>:</div>
                                ...
                                <div class="col-md-6 text-left">
                                    <select class="text-center" id="cod_respon" name="cod_respon" obl="1" validate="select">
    ...
    <div class="accordion"  >
        <h1 style="padding:6px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>SECCIÓN DE PERMISOS</b></h1>
        <div id="contenido">
            <div class="Style2DIV">
                ...
                <div class="accordion"  >
                    <?php foreach ($padres as $key => $value){
                        ...
                        ?>               
                            <h1 style="padding:6px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Módulo <?= $value[1] ?></b></h1>
                            <div id="contenido">
                                <div class="Style2DIV">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
