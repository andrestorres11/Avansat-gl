...
class Proc_perfil
{
    ...
    function Formulario2()
    {
        ...
        $formulario->nueva_tabla();
        $formulario->linea("Codigo", 0, "t");
        $formulario->linea($GLOBALS[cod_perfil_nue], 1, "i");
        ...
        $formulario->oculto("opcion", $GLOBALS[opcion], 0);
        $formulario->oculto("cod_servic", $GLOBALS["cod_servic"], 0);
        //$formulario->oculto("cod_perfil", $GLOBALS[cod_perfil_nue], 0);
    ...
    function Actualizar()
    {
        ...
        {
            $link_a = "<br><b><a href=\"index.php?&window=central&cod_servic=" . $GLOBALS[cod_servic] . " \"target=\"centralFrame\">Copiar Otro Perfil</a></b>";
