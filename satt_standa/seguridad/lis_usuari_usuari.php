...
class Proc_usuari {
    ...
    function Formulario() {
        ...
        $query = "SELECT a.cod_usuari,a.nom_usuari,a.usr_emailx,a.cod_perfil,a.num_cedula,a.usr_interf
        ...
        $formulario->linea($usuario[0][4], 1, "i");
        $formulario->linea("Nombre", 0, "t");
        ...
        $formulario->linea($usuario[0]['usr_interf'], 1, "i");
