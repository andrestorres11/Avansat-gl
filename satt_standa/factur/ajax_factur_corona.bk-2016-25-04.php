  ...
  */
  private function DataTipdes($_AJAX)
  {
    try 
    {
      ...
      $mHtml  = '<div class="StyleDIV" ><table width="80%" align="center">';
        $mHtml .= '<tr>';
          $mHtml .= '<td class="CellHead" align="center" >Despachos Generados</td>';
          $mHtml .= '<td class="CellHead" align="center" >Nº de Novedades Registrados</td>';
          $mHtml .= '<td class="CellHead" align="center" >Valor A Facturar</td>';
  ...
  private function DataEtapaDespac( $mDespac, $mEtapax, $mValor , $mCodTipdes = NULL)
  {
    ...
    $mHtml = '<div class="StyleDIV" ><table width="90%" align="center">';
      $mHtml .= '<tr>';
  ...
  private function getDataByNumDespac( $mNumDespac = NULL )
  {
    $mQuery  = "SELECT a.num_despac,
                     ...
                     FROM 
                          ...
                          ".BASE_DATOS.".tab_genera_tipdes i,
