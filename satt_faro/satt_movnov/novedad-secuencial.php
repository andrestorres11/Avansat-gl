...
class Novedad
{
    ...
    function Buscar()
    {
        ...
        if( $pc )
        {
            ...
            else
            {
                ...
                elseif($act_puecon && $act_puecon['cod_contro'] == $pc[(sizeof($pc)-1)]['cod_contro'])
                {
        ...
        if( $pc )
        {
            ...
            $form = new Form( array( 'name'=>'form', 'enctype'=>'multipart/form-data' ) );
                ...
                $form -> Row();
                    ...
                    {
                        $form -> Hidden( array( "name" => "cod_noveda", "value" => 71, "colspan" => 2 ));
                    }
                $form -> closeRow();
                ...
                if( $ind_noveda == 4 )
                {
                    $form -> Row();
                        ...
                        $form -> Select( array( "name" => "num_docume" ), $OPT_DESTIN, NULL );
                    $form -> closeRow();
                }
            ...
            echo "<div class='error' >La Placa <b>".$cod_usuari."</b> No tiene un Puesto de Control pendiente.</div>";
    }
    ...
    function Registrar()
    {
        ...
        try
        {
            $mParams = array( "nom_usuari" => 'admin', 
                              "pwd_clavex" => 'admin123',
    ...
    {
        $mSQL = "SELECT a.num_docume, a.nom_destin
