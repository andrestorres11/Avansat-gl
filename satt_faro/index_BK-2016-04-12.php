...
*/
die("<center><fieldset><legend>Actualizando la Aplicacion</legend>En este momento se esta realizando una actualizacion al sistema, por favor intente ingregar mas tarde.</fieldset></center>");
...
class Aplicacion_Seguridad
{
    ...
    function __construct()//Constructor de la clase
    {
        ...
        $this -> conexion = new Conexion('bd10.intrared.net', USUARIO, CLAVE, "".BASE_DATOS."");//Se crea la conexion a la base de datos
        $this -> principal();
    }
      ...
      echo "<link type=\"text/css\" rel=\"stylesheet\" href=\"../".DIR_APLICA_CENTRAL."/estilos/".ESTILO."/css/dhtmlgoodies_calendar.css?random=20051112\" media=\"screen\"></LINK>\n";
        echo "<SCRIPT type=\"text/javascript\" src=\"../".DIR_APLICA_CENTRAL."/js/dhtmlgoodies_calendar.js?random=20060118\"></script>\n";
         ...
         $cod_hijo = $datos_servicio["cod_servic"];
           ...
           if(($GLOBALS["cod_servic"] == "1308" || $GLOBALS["cod_servic"] == "499" || $GLOBALS["cod_servic"] == "1315" || $GLOBALS["cod_servic"] == "1410" || $GLOBALS["cod_servic"] == "1415" || $GLOBALS["cod_servic"] == "1420")&&($GLOBALS[opcion] == '1' || ($GLOBALS["cod_servic"] == "1420" && $GLOBALS[opcion] == '2')))
           	echo '';
           else
           {
