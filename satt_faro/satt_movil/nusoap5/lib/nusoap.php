...
$_REQUEST['_transient']['static']['nusoap_base']->globalDebugLevel = 9;
  ...
  //  var $soap_defencoding = 'ISO-8859-1';
	...
	*/
	function nusoap_base() {
		$this->debugLevel = $_REQUEST['_transient']['static']['nusoap_base']->globalDebugLevel;
	}
	...
	*/
	function getGlobalDebugLevel() {
		return $_REQUEST['_transient']['static']['nusoap_base']->globalDebugLevel;
	}
	...
	*/
	function setGlobalDebugLevel($level) {
		$_REQUEST['_transient']['static']['nusoap_base']->globalDebugLevel = $level;
	}
